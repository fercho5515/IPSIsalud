<%-- 
    Document   : carga_muestra_result_lab
    Created on : 16/05/2013, 07:06:35 PM
    Author     : EMMANUEL
--%>
...
<%@page import="pac.conexion" %>
  ...
  <%
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("rs.id_lab ", "cups cup,resu_laboratorios rs,consulta_medica c where rs.cod_examen=cup.id_cups and rs.id_consulta=c.id_consulta and c.serial_historia='"+session.getAttribute("serial_pacinete")+"' "+where+"");
                            ...
                            strQuery = "select rs.id_lab,rs.cod_examen,cup.cup_verdadero,cup.descripcion,rs.reporte,rs.fecha,rs.id_sol_lab,rs.id_consulta from cups cup,resu_laboratorios rs,consulta_medica c where rs.cod_examen=cup.id_cups and rs.id_consulta=c.id_consulta and c.serial_historia='"+session.getAttribute("serial_pacinete")+"' "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
   // System.out.println("==>"+strQuery);
                          ...
                          //  total = conexiondb.countRec("rs.id_lab ", "cups cup,resu_laboratorios rs,consulta_medica c where rs.cod_examen=cup.id_cups and rs.id_consulta=c.id_consulta and c.serial_historia='"+session.getAttribute("serial_pacinete")+"' "+where+"");
                            ...
                            while(rs.next()){
                                ...
                                json = json + "\n{";
                                json = json + "\"id\":\""+rs.getInt("id_lab")+"\",";
                                json = json + "\"cell\":["+rs.getInt("id_lab")+"";
                                json = json + ",\""+rs.getString("cod_examen")+"\"";;
                                ...
                                json = json + ",\""+rs.getString("id_sol_lab")+"\""; 
