<%-- 
    Document   : carga_soli_no_pos_med_gen
    Created on : 15/11/2013, 02:03:45 PM
    Author     : servidor
--%>
...
<%@page import="pac.conexion" %>
  ...
  <%
                          ...
                          // System.out.println(where);
                            ...
                            total = conexiondb.countRec("s.id_soli_no_post", "  soli_no_post s where s.cod_consulta='"+session.getAttribute("serial_consulta")+"'  "+where+"");
                        //      System.out.print("aa");
                            if( total>0 ) {
                            ...
                            strQuery = "select s.id_soli_no_post,s.nom_generc_uno,s.nom_generc_dos,s.nom_generc_tres from soli_no_post s where s.cod_consulta='"+session.getAttribute("serial_consulta")+"'  "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
