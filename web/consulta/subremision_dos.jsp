<%-- 
    Document   : subremision_dos
    Created on : 14/05/2013, 12:38:01 AM
    Author     : EMMANUEL
--%>
...
<html>
   ...
   $('#form_remision2').submit(function() {
                    ...
                    // Enviamos el formulario usando AJAX
                          $.ajax({
                              ...
                              success: function(data) {
                                  ...
                                  setTimeout ('sino2()',400); 
                                           }                             
                          })
                     
                          return false;
                      }); 
                      function sino(){alert("si no"+document.getElementById("result_form").value+"");}              
        </script>
    </head>
    <body>
    ...
    <br><center><a href="../index.jsp">volver</a></center>
        ...
        ba.cierraResultado(result); 
         ...
         String  sq2c="select anamnesis,ex_fisico,cod_diag,presuntivo,observaciones,id_especialidad from remision_espe where id_consulat='"+session.getAttribute("serial_consulta")+"';";
          String anamne="";
          String examfisi="";
          String cod_diag="";
          String ptresunt="";
          ...
          try{  
           ...
           while (result2.next()&&result2!=null) { 
                       ...
                       if(result2.getString(3)!=null && result2.getString(3).compareTo("null")!=0 ){
                                       cod_diag=""+result2.getString(3);                                                            
                                                                                                    }
                       if(result2.getString(4)!=null && result2.getString(4).compareTo("null")!=0 ){
                                       ptresunt=""+result2.getString(4);                                                            
                                                                                                    }
                       if(result2.getString(5)!=null && result2.getString(5).compareTo("null")!=0 ){
                                       observ=""+result2.getString(5);                                                            
                                                                                                    }
                       if(result2.getString(6)!=null && result2.getString(6).compareTo("null")!=0 ){
                                       idespe=""+result2.getString(6);                                                            
                                                                                                    }
                                               }
              }
        catch(SQLException ex){}
    ...
    %>
    <form id="form_remision2" name="form_remision2" action="actua_remision.jsp"  >       
    <fieldset>
...
<tr><td style="width:100%"><label>Diagnostico Presuntivo</label>  
        <select style="width:85%;height:22px" id="select_diag" name="select_diag" onchange="cambiadiag()">
              ...
              <%   
                   for(int j=0;j<i;j++){ 
                          if(cod_diag.compareTo(datos[j][0])==0){out.println("<option value='"+datos[j][0]+"' SELECTED>"+datos[j][0]+" - "+datos[j][1]+"</option>");}
                          else{out.println("<option value='"+datos[j][0]+"'>"+datos[j][0]+" - "+datos[j][1]+"</option>");}
                                       }
              %>                              
           </select>
    </td></tr>
<tr><td style="width:100%"><label>Tratamiento</label></td></tr>
<tr><td><textarea rows="4" id="presuntivo" name="presuntivo" style="width:100%" ><% out.print(ptresunt); %></textarea></td></tr>
<tr><td style="width:100%"><label>Observaciones</label></td></tr>
<tr><td style="display: none" style="display: none"><textarea rows="4" id="obsevaciones_remi" name="obsevaciones_remi" style="width:100%"><% out.print(observ); %>.</textarea></td></tr>
                 ...
                 <option value="npa">Seleccione especialidad</option>
                    ...
                    try{  
                     ...
                     while (resulta.next()&&resulta!=null) { 
                         if(resulta.getString(1).compareTo(idespe)==0){out.print("<option value='"+resulta.getString(1)+"' SELECTED>"+resulta.getString(2)+"</option>");}
                          else{out.print("<option value='"+resulta.getString(1)+"'>"+resulta.getString(2)+"</option>");}
                                                         }
                        }
                  catch(SQLException ex){}
                  catch(Exception exe){}
...
<br>
<center><input type="submit" value="Actualizar" name="aceptar" size="25" id="aceptar"><input type="button" value="Borrar" id="aceptar" nameid="aceptar" onclick="borraremis()"></center>
</fieldset>
    </form>  
  <%  
