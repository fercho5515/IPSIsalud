<%-- 
    Document   : carga_imagenes
    Created on : 17/05/2013, 12:01:17 PM
    Author     : EMMANUEL
--%>
  ...
  <%
                         ...
                         //  System.out.println(where);
                            ...
                            /*-----------------------------------------------------------------------------------------------------------*/
                               ...
                               total = conexiondb.countRec("id_cups ", " cups where  (tipo='0' or tipo='1') and permi"+session.getAttribute("permiso")+"='1' and (sexo='"+session.getAttribute("genero_paciente")+"' or sexo='0') and id_cups not in (select DISTINCT id_img from imgs_sol where serial_historia='"+session.getAttribute("serial_pacinete")+"' and leido='0') "+where+"");
                            ...
                            strQuery = "select id_cups,descripcion,cup_verdadero from cups where  (tipo='0' or tipo='1') and permi"+session.getAttribute("permiso")+"='1' and (sexo='"+session.getAttribute("genero_paciente")+"' or sexo='0') and id_cups not in (select DISTINCT id_img from imgs_sol where serial_historia='"+session.getAttribute("serial_pacinete")+"' and leido='0') "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
   //System.out.println("carga imagenes: "+strQuery);
