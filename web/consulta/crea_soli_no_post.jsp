<%-- 
    Document   : crea_soli_no_post
    Created on : 9/07/2013, 08:29:35 PM
    Author     : EMMANUEL
--%>
    ...
    <body>
        <%
         ...
         if(session.getAttribute("nombre")==null||session.getAttribute("clave")==null||session.getAttribute("id")==null || session.getAttribute("permiso")==null || session.getAttribute("serial_agenda" )==null || session.getAttribute("serial_pacinete")==null ){}
                ...
                String sql="INSERT INTO `ips_isalud`.`soli_no_post` (`cod_consulta`, `diagnostico`, `resu_enf_act`, `nom_generico_uno`, `presen_concen_uno`, `dosis_fecuencia_uno`, `nom_generico_dos`, `presen_concen_dos`, `dosis_fecuencia_dos`, `uno`, `dos`, `tres`, `cuatro`, `cinco`, `seis`, `efecto_trata`, `efecto_secu`, `tiempo_resp_espe`, `especialidad`, `nom_generc_uno`, `posologia_uno`, `presentacion_uno`, `dosis_uno`, `cantidad_uno`, `tiempo_uno`, `reg_invima_uno`, `nom_generc_dos`, `posologia_dos`, `presentacion_dos`, `dosis_dos`, `cantidad_dos`, `tiempo_dos`, `reg_invima_dos`, `nom_generc_tres`, `posologia_tres`, `presentacion_tres`, `dosis_tres`, `cantidad_tres`, `tiempo_tres`, `reg_invima_tres`) VALUES ('"+session.getAttribute("serial_consulta")+"',"+diag_solo_no_pos+","+resu_enf_actual+","+nom_generic_1+","+present_y_concent_1+","+dos_frec_dur_trat_1+","+nom_generic_2+","+present_y_concent_2+","+dos_frec_dur_trat_2+","+t1_soli_no_pos+","+t2_soli_no_pos+","+t3_soli_no_pos+","+t4_soli_no_pos+","+t5_soli_no_pos+","+t6_soli_no_pos+","+efecto_deseado+","+efectos_secundarios+","+tiempo_respuesta+",null,"+n_omgeneric_1+","+n_posologia_1+","+n_presentac_1+","+n_dosis_dia_1+","+nn_cantidad_1+","+n_tiemp_mes_1+","+n_re_invima_1+", "+n_omgeneric_2+","+n_posologia_2+","+n_presentac_2+","+n_dosis_dia_2+","+nn_cantidad_2+","+n_tiemp_mes_2+","+n_re_invima_2+", "+n_omgeneric_3+","+n_posologia_3+","+n_presentac_3+","+n_dosis_dia_3+","+nn_cantidad_3+","+n_tiemp_mes_3+","+n_re_invima_3+");";
// + "INSERT INTO `ips_isalud`.`remision_espe` (`id_consulat`, `anamnesis`, `ex_fisico`, `cod_diag`, `presuntivo`, `observaciones`, `id_especialidad`) VALUES ('"+session.getAttribute("serial_consulta")+"', '"+aname+"', '"+exame_fisi+"', '"+cod_diag+"', '"+presun+"', '"+observa+"','"+id_espe+"');";
                ...
                if(ba.transaccion(sql)){out.print(" <input type='hidden' id='result_form_nopos' name='result_form_nopos' value='1'>");}
                else{out.print(" <input type='hidden' id='result_form_nopos' name='result_form_nopos' value='0'>");}
                ba.cerrar();           
