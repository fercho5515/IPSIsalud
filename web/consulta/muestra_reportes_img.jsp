<%-- 
    Document   : muestra_reportes_img
    Created on : 19/05/2013, 10:42:36 PM
    Author     : EMMANUEL
--%>
...
%>      <center>
        ...
        <div id="datos_per" name="datos_per" style="text-align:left">
            ...
            <center><h2>DATOS DE LABORATORIO</h2></center>
               <%             String datrs0[] = new String[6];
                        ...
                        String sqlrs0=" select cu.cup_verdadero,cu.descripcion,p_nom,s_nom,p_ape,s_ape,ims.fecha_soli,ims.descri,ims.archi_img from imgs_sol ims,personas p,consulta_medica c,cups cu where ims.id_consulta=c.id_consulta and c.id_medico=p.serial and cu.id_cups=ims.id_img and ims.serial='"+pide+"'";
   ...
   %>
         ...
         <%             String datrs[] = new String[4];
                        ...
                        String sqlrs="select p_nom,s_nom,p_ape,s_ape,rs.fecha,rs.reporte,rs.ruta from resu_img rs,personas p,consulta_medica c where rs.id_consulta=c.id_consulta and c.id_medico=p.serial and id_ima='"+resultaaa+"';";
   ...
   %>
         <table border="0"  style="width:100%">
          ...
          <%  if(datrs[3]==null || datrs[3].compareTo("")==0 || datrs[3].compareTo("null")==0){
            ...
            <a href='../archivos/imagenes/<% out.print(datrs[3]);  %>' >descargar si archivo esta en formato no compatible</a> 
            <div align="center">
            <embed src='../archivos/imagenes/<% out.print(datrs[3]);  %>' width="100%" height="100%" style="min-height:750px"></embed> 
            </div>
           <% } %>   
           <br>
            ...
            <a href='../archivos/imagenes/<% out.print(datrs0[5]);  %>' >descargar si archivo esta en formato no compatible</a> 
            <div align="center">
            <embed src='../archivos/imagenes/<% out.print(datrs0[5]);  %>' width="100%" height="100%" style="min-height:750px"></embed> 
            </div>
           <% } %> 
        </div></center>
        <% ba.cerrar(); %>    
