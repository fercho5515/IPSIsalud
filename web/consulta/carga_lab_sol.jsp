<%-- 
    Document   : carga_lab_sol
    Created on : 10/05/2013, 11:15:27 AM
    Author     : EMMANUEL
--%>
...
<%@page import="pac.conexion" %>
  ...
  <%
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("serial ", " labs_sol,cups where id_cups=id_lab and leido=0 and serial_historia='"+session.getAttribute("serial_pacinete")+"' "+where+"");
                            ...
                            strQuery = "select serial,id_consulta,cup_verdadero,descripcion,descri,fecha_soli from labs_sol,cups where id_cups=id_lab and leido=0 and serial_historia='"+session.getAttribute("serial_pacinete")+"' "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
