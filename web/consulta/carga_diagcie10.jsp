...
<%@page import="pac.conexion" %>
  ...
  <%
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("imp.id_subcie ", " impre_diagno imp,tipo__diagnostico t,causa_externa ce,sub_cie10 s where imp.id_subcie=s.id_subcie10 and imp.id_tipo_diagnostico=t.idtipodiag and imp.causa_externa=ce.idcausa and id_consulta='"+session.getAttribute("serial_consulta")+"' "+where+"");
                            ...
                            strQuery = "select imp.id_subcie,s.descripcion as d1,t.descripcion as d2,ce.descripcion as d3,imp.descrip from impre_diagno imp,tipo__diagnostico t,causa_externa ce,sub_cie10 s where imp.id_subcie=s.id_subcie10 and imp.id_tipo_diagnostico=t.idtipodiag and imp.causa_externa=ce.idcausa and id_consulta='"+session.getAttribute("serial_consulta")+"' "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
