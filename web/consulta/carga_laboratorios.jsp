<%-- 
    Document   : carga_laboratorios
    Created on : 10/05/2013, 01:16:53 PM
    Author     : EMMANUEL
--%>
...
<%@page import="pac.conexion" %>
  ...
  <%
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("id_cups ", "  cups where  (tipo='0' or tipo='2') and  permi"+session.getAttribute("permiso")+"='1' and (sexo='"+session.getAttribute("genero_paciente")+"' or sexo='0') and id_cups not in (select DISTINCT id_lab from labs_sol where serial_historia='"+session.getAttribute("serial_pacinete")+"' and leido='0')  "+where+"");
