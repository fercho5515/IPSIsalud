<%-- 
    Document   : carga_antecedentes_personales
    Created on : 24/02/2013, 03:10:41 PM
    Author     : EMMANUEL
--%>
...
<%@page import="pac.conexion" %>
  ...
  <%
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("e.id_parte ", "ex_cefalocaudal e,partes_cuerpo p where e.id_parte=p.id_parte and e.id_consulta='"+session.getAttribute("serial_consulta")+"' "+where+"");
                            ...
                            strQuery = "select e.id_parte,p.descripcion,e.dolencia from ex_cefalocaudal e,partes_cuerpo p where e.id_parte=p.id_parte and e.id_consulta='"+session.getAttribute("serial_consulta")+"' "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
  //    System.out.println("==>"+strQuery);
                            ...
                            while(rs.next()){
                                ...
                                json = json + "\n{";
                                json = json + "\"id\":\""+rs.getInt("id_parte")+"\",";
                                json = json + "\"cell\":["+rs.getInt("id_parte")+"";
                                json = json + ",\""+rs.getString("descripcion")+"\"";  
                                json = json + ",\""+rs.getString("dolencia")+"\"]";
                                json = json + "}";
