<%-- 
    Document   : carga_img_sol
    Created on : 17/05/2013, 12:08:58 PM
    Author     : EMMANUEL
--%>
...
<%@page import="pac.conexion" %>
  ...
  <%
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("serial ", " imgs_sol,cups where id_cups=id_img and leido=0 and serial_historia='"+session.getAttribute("serial_pacinete")+"' "+where+"");
                            ...
                            strQuery = "select serial,id_consulta,cup_verdadero,descripcion,descri,fecha_soli from imgs_sol,cups where id_cups=id_img and leido=0 and serial_historia='"+session.getAttribute("serial_pacinete")+"' "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
