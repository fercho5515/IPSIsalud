<%-- 
    Document   : sub_soli_no_post_dos
    Created on : 9/07/2013, 02:50:07 PM
    Author     : EMMANUEL
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript">
             ...
             $('#form_dos_soli_no_pos').submit(function() {
...
<%
   ...
   String sql0="select diagnostico,resu_enf_act,nom_generico_uno,presen_concen_uno,dosis_fecuencia_uno,nom_generico_dos,presen_concen_dos,dosis_fecuencia_dos,uno,dos,tres,cuatro,cinco,seis,efecto_trata,efecto_secu,tiempo_resp_espe,especialidad,nom_generc_uno,posologia_uno,presentacion_uno,dosis_uno,cantidad_uno,tiempo_uno,reg_invima_uno,nom_generc_dos,posologia_dos,presentacion_dos,dosis_dos,cantidad_dos,tiempo_dos,reg_invima_dos,nom_generc_tres,posologia_tres,presentacion_tres,dosis_tres,cantidad_tres,tiempo_tres,reg_invima_tres from soli_no_post where cod_consulta='"+session.getAttribute("serial_consulta")+"'";
...
%>        
           <form method="post" id="form_dos_soli_no_pos" name="form_dos_soli_no_pos" action="actua_soli_no_post.jsp">
        <center>
<br/>
     ...
     <%    String  sql1="select imp.id_subcie,sub.descripcion,imp.descrip from sub_cie10 sub,impre_diagno imp where imp.id_subcie=sub.id_subcie10 and id_consulta='"+session.getAttribute("serial_consulta")+"' order by control;";
          ...
          try{  
           ...
           while (result1.next()&&result1!=null) { 
               if(daatics[0].compareTo(result1.getString(1))==0){ out.print("<option value='"+result1.getString(1)+"' SELECTED>"+result1.getString(1)+" - "+result1.getString(2)+"</option>");}
               else{   out.print("<option value='"+result1.getString(1)+"'>"+result1.getString(1)+" - "+result1.getString(2)+"</option>");}
                                               }
              }
        catch(SQLException ex){}
	catch(Exception exe){}
...
<table id="tablap" name="tablap" style="width:100%" border="1">
   ...
   <tr>
     ...
     <td id="tdp" name="tdp" style="width:22%"><center><label><input type="text" name="n_omgeneric_1" maxlength="199" id="n_omgeneric_1" style="width:98%"  value="<% out.print(daatics[18]); %>" /></label></center></td>
       <td id="tdp" name="tdp" style="width:12%"><center><label><input type="text" name="n_posologia_1" maxlength="199" id="n_posologia_1" style="width:98%"  value="<% out.print(daatics[19]); %>" /></label></center></td>
       <td id="tdp" name="tdp" style="width:13%"><center><label><input type="text" name="n_presentac_1" maxlength="199" id="n_presentac_1" style="width:98%"  value="<% out.print(daatics[20]); %>" /></label></center></td>
       <td id="tdp" name="tdp" style="width:12%"><center><label><input type="text" name="n_dosis_dia_1" maxlength="199" id="n_dosis_dia_1" style="width:98%"  value="<% out.print(daatics[21]); %>" /></label></center></td>
       <td id="tdp" name="tdp" style="width:13%"><center><label><input type="text" name="nn_cantidad_1" maxlength="199" id="nn_cantidad_1" style="width:98%"  value="<% out.print(daatics[22]); %>" /></label></center></td>
       ...
       <td id="tdp" name="tdp" style="width:13%"><center><label><input type="text" name="n_re_invima_1" maxlength="199" id="n_re_invima_1" style="width:95%;border-radius: 0px 0px 0px 0px;" value="<% out.print(daatics[24]); %>" /></label></center></td>
   </tr>
   <tr>
       <td id="tdp" name="tdp" style="width:3%"><center><label>2</label></center></td>
       <td id="tdp" name="tdp" style="width:22%"><center><label><input type="text" name="n_omgeneric_2" maxlength="199" id="n_omgeneric_2" style="width:98%" value="<% out.print(daatics[25]); %>" /></label></center></td>
       <td id="tdp" name="tdp" style="width:12%"><center><label><input type="text" name="n_posologia_2" maxlength="199" id="n_posologia_2" style="width:98%" value="<% out.print(daatics[26]); %>" /></label></center></td>
       <td id="tdp" name="tdp" style="width:13%"><center><label><input type="text" name="n_presentac_2" maxlength="199" id="n_presentac_2" style="width:98%" value="<% out.print(daatics[27]); %>"  /></label></center></td>
       <td id="tdp" name="tdp" style="width:12%"><center><label><input type="text" name="n_dosis_dia_2" maxlength="199" id="n_dosis_dia_2" style="width:98%" value="<% out.print(daatics[28]); %>"  /></label></center></td>
       <td id="tdp" name="tdp" style="width:13%"><center><label><input type="text" name="nn_cantidad_2" maxlength="199" id="nn_cantidad_2" style="width:98%" value="<% out.print(daatics[29]); %>"  /></label></center></td>
       ...
       <td id="tdp" name="tdp" style="width:13%"><center><label><input type="text" name="n_re_invima_2" maxlength="199" id="n_re_invima_2" style="width:95%;border-radius: 0px 0px 0px 0px;" value="<% out.print(daatics[31]); %>"  /></label></center></td>
   </tr>
   <tr>
       <td id="tdp" name="tdp" style="width:3%;border-radius: 0px 0px 0px 10px;"><center><label>3</label></center></td>
       <td id="tdp" name="tdp" style="width:22%"><center><label><input type="text" name="n_omgeneric_3" maxlength="199" id="n_omgeneric_3" style="width:98%" value="<% out.print(daatics[32]); %>"  /></label></center></td>
       <td id="tdp" name="tdp" style="width:12%"><center><label><input type="text" name="n_posologia_3" maxlength="199" id="n_posologia_3" style="width:98%" value="<% out.print(daatics[33]); %>"  /></label></center></td>
       <td id="tdp" name="tdp" style="width:13%"><center><label><input type="text" name="n_presentac_3" maxlength="199" id="n_presentac_3" style="width:98%" value="<% out.print(daatics[34]); %>"  /></label></center></td>
       <td id="tdp" name="tdp" style="width:12%"><center><label><input type="text" name="n_dosis_dia_3" maxlength="199" id="n_dosis_dia_3" style="width:98%" value="<% out.print(daatics[35]); %>"  /></label></center></td>
       <td id="tdp" name="tdp" style="width:13%"><center><label><input type="text" name="nn_cantidad_3" maxlength="199" id="nn_cantidad_3" style="width:98%" value="<% out.print(daatics[36]); %>"  /></label></center></td>
       ...
       <td id="tdp" name="tdp" style="width:13%;border-radius: 0px 0px 10px 0px;"><center><label><input type="text" name="n_re_invima_3" maxlength="199" id="n_re_invima_3" style="width:95%;border-radius: 0px 0px 10px 0px;" value="<% out.print(daatics[38]); %>"  /></label></center></td>
   </tr>
...
<table id="tablap" name="tablap" style="width:100%" border="1">
   ...
   <tr>
        ...
        <center><textarea style="width:98%" rows="2" name="tiempo_respuesta" maxlength="299" id="tiempo_respuesta"><% out.print(daatics[16]); %></textarea></center> 
         ...
         <br>
         <input type="submit" value="Actualizar" name="aceptar" style="font-size:22px;width:130px" id="aceptar" >
        <input type="button" value="Borrar" id="aceptar" style="font-size:22px;width:130px" nameid="aceptar" onclick="borrasolinposs()">
        </center>
    </form>
