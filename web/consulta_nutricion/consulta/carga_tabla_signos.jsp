...
<%@page import="pac.conexion" %>
  <%  request.setCharacterEncoding("UTF-8");
                        ...
                        //   System.out.println(where);
                            ...
                            total = conexiondb.countRec("hst.coment", "histo_subsig hst, sub_signos ss, signos_desnu sd where hst.id_sub_sig=ss.id_sub_signos and ss.id_signos=sd.id_signos and hst.id_consulta='"+session.getAttribute("serial_consulta")+"' "+where+"");
                       //   System.out.print("aa");
                            if( total>0 ) {
                            ...
                            strQuery = "select hst.id_sub_sig as ids,sd.descripcion as parte,ss.decripcion as signo,hst.coment from histo_subsig hst, sub_signos ss, signos_desnu sd where hst.id_sub_sig=ss.id_sub_signos and ss.id_signos=sd.id_signos and hst.id_consulta='"+session.getAttribute("serial_consulta")+"' "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
                          ...
                          //  total = conexiondb.countRec("hst.coment", "histo_subsig hst, sub_signos ss, signos_desnu sd where hst.id_sub_sig=ss.id_sub_signos and ss.id_signos=sd.id_signos and hst.id_consulta='"+session.getAttribute("serial_consulta")+"' "+where+"");
                            ...
                            while(rs.next()){
                                ...
                                json = json + "\"id\":\""+cont+"\",";
                                json = json + "\"cell\":["+cont+"";
                                json = json + ",\""+rs.getString("ids")+"\"";  
                                json = json + ",\""+rs.getString("parte")+"\"";                                
                                json = json + ",\""+rs.getString("signo")+"\"";
                                json = json + ",\""+rs.getString("hst.coment")+"\"]";
                                json = json + "}";
