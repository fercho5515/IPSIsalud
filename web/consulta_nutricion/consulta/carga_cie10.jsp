...
<%@page import="pac.conexion" %>
  ...
  <%
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("s.id_subcie10", "cie10 c,sub_cie10 s where s.cie10=c.idcie10 "+where+"");
                            ...
                            strQuery = "select  c.descripcion as d1,s.id_subcie10,s.descripcion from cie10 c,sub_cie10 s where s.cie10=c.idcie10 "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
