<%-- 
    Document   : carga_menu
    Created on : 18/10/2013, 12:37:00 PM
    Author     : Emmanuel
--%>
...
<%@page import="pac.conexion" %>
  ...
  <%
                            ...
                            if(busca.compareTo("true")==0){
                                        ...
                                        try {
                                             ...
                                             for(int i=0;i<Integer.parseInt(""+msg.size());i++){   ///ago un ciclo para todad las restricciones
                                                ...
                                                if(campo.compareTo("d1")==0){campo="h.descripcion";}
                                                else if(campo.compareTo("d2")==0){campo="c.descripcion";}
                                                else if(campo.compareTo("cant")==0){campo="m.cantidad";}
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("h.descripcion", " menu_comida m,hora_comida h,comida c where m.id_comida=c.id_comida and c.id_hora_comida=h.id_hora_comida and m.id_consulta_nutri='"+session.getAttribute("serial_consulta")+"' "+where+"");
                            ...
                            strQuery = "select h.descripcion as d1,c.descripcion as d2,m.cantidad as cant from menu_comida m,hora_comida h,comida c where m.id_comida=c.id_comida and c.id_hora_comida=h.id_hora_comida and m.id_consulta_nutri='"+session.getAttribute("serial_consulta")+"' "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
                 //     System.out.println("sql carga_menu.jsp ==> "+strQuery);
