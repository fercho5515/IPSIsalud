...
<%@page import="pac.conexion" %>
  ...
  <%
                         ...
                         //  System.out.println(where);
                            ...
                            /*-----------------------------------------------------------------------------------------------------------*/
                            //
                              total = conexiondb.countRec("co.id_consulta ", " agenda a,procedimientos_tari p,cups c,consulta_nutri co where a.id_procedimiento=p.idprocedimientos_tari  and p.cod_cups=c.id_cups  and co.id_consulta=a.id_consulta and a.id_paciente='"+session.getAttribute("serial_pacinete")+"' and co.guardado='1'  "+where+"");
                            ...
                            strQuery = "select co.id_consulta,date(co.fecha) as fecha,c.descripcion as descripcion from agenda a,procedimientos_tari p,cups c,consulta_nutri co where a.id_procedimiento=p.idprocedimientos_tari  and p.cod_cups=c.id_cups  and co.id_consulta=a.id_consulta and a.id_paciente='"+session.getAttribute("serial_pacinete")+"' and co.guardado='1' "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
