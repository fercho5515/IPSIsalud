...
<%@page import="pac.conexion" %>
  ...
  <%
                          ...
                          // System.out.println(where);
                            ...
                            total = conexiondb.countRec("r.id_recom", "recomendacion r,permisos p,personas p1 where r.id_medico_recom=p1.serial and r.permiso_med_recom=p.id_permi and r.id_paciente='"+session.getAttribute("serial_pacinete")+"' and id_para_quien='"+session.getAttribute("permiso")+"' and leida='0' "+where+"");
                           // System.out.print("aa");
                            if( total>0 ) {
