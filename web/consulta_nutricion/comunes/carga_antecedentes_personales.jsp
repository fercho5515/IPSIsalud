...
<%@page import="pac.conexion" %>
  ...
  <%
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("a.id_antecedentes_personales", " antecedentes_personales a,tipo_antecedente t,descripcion_antecedente d where a.id_descri_antecedente=d.id_descri_antecedente and a.id_permiso='"+session.getAttribute("permiso")+"' and d.id_tipo_antecedente=t.serial and a.id_historia_clinica='"+(String)session.getAttribute("serial_pacinete")+"'"+where+"");
       ...
       //  System.out.println("carga antecedentes personales:"+strQuery);
                            ...
                            while(rs.next()){
                                ...
                                json = json + "\n{";
                                json = json + "\"id\":\""+rs.getInt("id_antecedentes_personales")+"\",";
                                json = json + "\"cell\":["+rs.getInt("id_antecedentes_personales")+"";
