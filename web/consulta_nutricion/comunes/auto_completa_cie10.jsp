<%-- 
    ...
    Created on : 20/03/2013, 11:18:30 AM
    Author     : EMMANUEL
--%>
 ...
 ResultSet resu=ba.consultas(sql);
	...
	try{
	    while (resu.next()&&resu!=null) { 
                        %>
                        <div class="display_box" align="left" onclick="pasadatopsico('<% out.print(resu.getString(1));%>','<% out.print(resu.getString(2));%>','<% out.print(dato2); %>')">
