...
%>      <center>
        <div style="width:90%"> 
          ...
          <%  
            ...
            String sqlc="select id_consulta from consulta_medica where serial_historia='"+cod_paciente+"' and id_permiso_profecional='"+permi+"' and id_estado_consulta='3' order by fecha";
            ResultSet resuc=null;
           int conut=0;
                        try{  resuc=ba.consultas(sqlc);
                              while (resuc.next()&&resuc!=null) {  
                                               out.print("<div id='contenedor_consulta_"+conut+"' style='width:90%' ></div><br> ");
                                               out.print("<script type='text/javascript'>$(\"#contenedor_consulta_"+conut+"\").load(\"consulta_medica_ant.jsp?cod_con="+resuc.getString(1)+"\");</script>");
                                               conut=conut+1;
                                                                     }
                           }                       
                        catch(SQLException ex){}
