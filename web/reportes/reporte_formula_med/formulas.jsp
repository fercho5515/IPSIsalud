...
<html>
    ...
    <body>
      <%   
         ...
         String cod_con=request.getParameter("cod_con");  
...
String dir = context.getRealPath(request.getContextPath());
      */
         try {     
                    Connection conexion;
                   ...
                   // File reportFile = new File(r.dir()+"/ISALUD/reportes/reporte_formula_med/report_formulita_2.jasper"); 
                    File reportFile = new File(r.dir()+"/reportes/reporte_formula_med/report_formulita_2.jasper"); 
