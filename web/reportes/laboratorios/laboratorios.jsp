        ...
        if(request.getParameter("cod_con")!=null){cod_con=request.getParameter("cod_con"); } 
         ...
         try {     
                   ...
                   // File reportFile = new File(r.dir()+"/ISALUD/reportes/laboratorios/laboratorios.jasper");                     
                    //File reportFile = new File(r.dir()+"/ISALUD/reportes/laboratorios/laboratorio_dos.jasper");                   
                    File reportFile = new File(r.dir()+"/reportes/laboratorios/laboratorio_dos.jasper"); 
