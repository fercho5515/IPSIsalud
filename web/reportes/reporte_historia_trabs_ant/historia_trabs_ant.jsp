...
<html>
    <head>
      ...
      /*   if(permi.compareTo("1")==0){titu="Historia Clinica de Enfermeria";}
         ...
         titu="Historia Clinica de Trabajo Social";
         //////////////////////////
             //////////////////////7
...
%>      <center>
        <div style="width:90%"> 
          ...
          <%  
            ...
            String sqlc="SELECT id_consulta_trabajo_social FROM ips_isalud.consulta_trabajo_social where guardado='1' and id_historia='"+cod_paciente+"' order by fecha;";
           ...
           int conut=0;
                        try{  resuc=ba.consultas(sqlc);
                              while (resuc.next()&&resuc!=null) {  
                                             ...
                                             out.print("<script type='text/javascript'>$(\"#contenedor_consulta_"+conut+"\").load(\"consulta_trabs_ant_imp.jsp?cod_con="+resuc.getString(1)+"\");</script>");
                                             conut=conut+1;
                                                                     }
                           }                       
                        catch(SQLException ex){}
