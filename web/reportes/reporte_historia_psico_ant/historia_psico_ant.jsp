...
<html>
    <head>
      ...
      /*   if(permi.compareTo("1")==0){titu="Historia Clinica de Enfermeria";}
         ...
         titu="Historia Clinica de Psicologia";
         //////////////////////////
             //////////////////////7
...
%>      <center>
        <div style="width:90%"> 
          ...
          <%  
            ...
            String sqlc="SELECT id_consulta FROM consulta_psico where id_historia='"+cod_paciente+"' and guardado='3' order by fecha";
           ...
           int conut=0;
                        try{  resuc=ba.consultas(sqlc);
                              while (resuc.next()&&resuc!=null) {  
                                               ...
                                               out.print("<script type='text/javascript'>$(\"#contenedor_consulta_"+conut+"\").load(\"consulta_psico_ant.jsp?cod_con="+resuc.getString(1)+"\");</script>");
                                               conut=conut+1;
                                                                     }
                           }                       
                        catch(SQLException ex){}
