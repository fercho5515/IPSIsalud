<%-- 
    Document   : carga_laboratorio_farmaceutico
    Created on : 11/03/2013, 05:17:13 PM
    Author     : EMMANUEL
--%>
...
<%@page import="pac.conexion" %>
  ...
  <%                        request.setCharacterEncoding("UTF-8");
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("idlab_farmaceutico", "lab_farmaceutico"+where+"");
                            ...
                            strQuery = "select idlab_farmaceutico,nombre,direccion,telefono,nit from lab_farmaceutico"+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
      System.out.println(strQuery);
                         ...
                         ///   total = conexiondb.countRec("idlab_farmaceutico","lab_farmaceutico"+where+"");
                            ...
                            while(rs.next()){
                                ...
                                json = json + "\n{";
                                json = json + "\"id\":\""+rs.getInt("idlab_farmaceutico")+"\",";
                                json = json + "\"cell\":["+rs.getInt("idlab_farmaceutico")+"";
