...
<%@page import="pac.conexion" %>
  ...
  <%
                          ...
                          // System.out.println(where);
                            ...
                            total = conexiondb.countRec("pt.idprocedimientos_tari", "cups c, procedimientos_tari pt where pt.cod_cups=c.id_cups "+where+"");
                            ...
                            strQuery = "select pt.idprocedimientos_tari,c.cup_verdadero,pt.codigo_maipos,pt.descripcion as d1 from cups c, procedimientos_tari pt where pt.cod_cups=c.id_cups "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
