<%-- 
    Document   : carga_eps
    Created on : 28-ago-2013, 21:44:32
    Author     : servidor
--%>
...
<%@page import="pac.conexion" %>
  ...
  <%                        request.setCharacterEncoding("UTF-8");
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("id_resolucion_dian","resolucion_dian "+where+"");
                          //     System.out.println("total "+total);
                            ...
                            strQuery = "select id_resolucion_dian,numero_resolucion,fecha_resolucion,num_inicial,num_final,tipo_factura,estado from resolucion_dian "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
                          ...
                          //  total = conexiondb.countRec("id_resolucion_dian","resolucion_dian "+where+"");
                           //    System.out.println("total2 "+total);
                            ...
                            while(rs.next()){
                                ...
                                json = json + "\n{";
                                json = json + "\"id\":\""+rs.getInt("id_resolucion_dian")+"\",";
                                json = json + "\"cell\":["+rs.getInt("id_resolucion_dian")+"";
                                json = json + ",\""+rs.getString("numero_resolucion")+"\"";                                
                                json = json + ",\""+rs.getString("fecha_resolucion")+"\"";
                                json = json + ",\""+rs.getString("num_inicial")+"\"";
                                json = json + ",\""+rs.getString("num_final")+"\"";
                                json = json + ",\""+rs.getString("tipo_factura")+"\"";
                                json = json + ",\""+rs.getString("estado")+"\"]";
                                json = json + "}";
                                rc=true; 
                            }
