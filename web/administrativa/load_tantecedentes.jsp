...
<%@page import="pac.conexion" %>
  ...
  request.setCharacterEncoding("UTF-8");         
                     ...
                     //      System.out.println(where);
                            ...
                            total = conexiondb.countRec("td.serial", "tipo_antecedente as td "+where+"");
                            ...
                            strQuery = "SELECT td.serial as id,td.descripcion as descr FROM tipo_antecedente as td "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
