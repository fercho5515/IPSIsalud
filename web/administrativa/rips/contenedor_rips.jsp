...
function cambiaRsp(pestana){
                                if(pestana==1){$("#tabs-rips").load("rips/generar_rips.jsp");}
                           else if(pestana==2){$("#tabs-rips").load("rips/consultar_rips.jsp");}
...
<div id="tabs_rsp2" style="height:100%;width:99%;">
    <ul>    
        <li><a href="#tabs-rips" onclick="cambiaRsp(1)">Generar Rips</a></li>
        <li><a href="#tabs-rips" onclick="cambiaRsp(2)">Editar Resolución de la DIAN</a></li>
