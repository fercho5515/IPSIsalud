...
<%@page import="pac.conexion" %>
  ...
  request.setCharacterEncoding("UTF-8");         
                     ...
                     //      System.out.println(where);
                            ...
                            total = conexiondb.countRec("hc.id_hora_comida", "hora_comida as hc "+where+"");
                            ...
                            strQuery = "select hc.id_hora_comida as id,hc.descripcion as descr FROM hora_comida as hc "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
                            //out.print(strQuery);
