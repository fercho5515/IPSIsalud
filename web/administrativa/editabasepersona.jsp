...
$(document).ready(function() {
 ...
 <body>        <% request.setCharacterEncoding("UTF-8");
    ...
    <br><center><a href="../index.jsp">volver</a></center>
     ...
     %>         
    <form name="form_crea_emp" id="form_crea_emp" target="upload_target_emp" action="edita_persona.jsp" method="post"  onsubmit="return validacreaemp();" enctype="multipart/form-data" >     
