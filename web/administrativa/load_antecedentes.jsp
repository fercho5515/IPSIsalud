...
<%@page import="pac.conexion" %>
  ...
  request.setCharacterEncoding("UTF-8");         
                     ...
                     //      System.out.println(where);
                            ...
                            total = conexiondb.countRec("da.id_descri_antecedente", "descripcion_antecedente as da,tipo_antecedente as ta where da.id_tipo_antecedente=ta.serial and da.id_tipo_antecedente='"+id+"' "+where+"");
                            ...
                            strQuery = "select da.id_descri_antecedente as id,da.id_tipo_antecedente as ta,da.descripcion as des,da.sexo as sx from descripcion_antecedente as da,tipo_antecedente as ta where da.id_tipo_antecedente=ta.serial and da.id_tipo_antecedente='"+id+"' "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
                        //    System.out.print(strQuery);
                         ...
                         //   total = conexiondb.countRec("da.id_descri_antecedente", "descripcion_antecedente as da,tipo_antecedente as ta where da.id_tipo_antecedente=ta.serial and da.id_tipo_antecedente='"+id+"' "+where+"");
                            ...
                            while(rs.next()){
                                ...
                                json = json + ",\""+rs.getString("ta")+"\"";
                                json = json + ",\""+rs.getString("des")+"\"";
                                json = json + ",\""+rs.getString("sx")+"\"]";
                                json = json + "}";
