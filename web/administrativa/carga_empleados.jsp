  ...
  <%  request.setCharacterEncoding("UTF-8");
                         ...
                         //  System.out.println(where);
                          ...
                          //     System.out.println("total "+total);
                            ...
                            strQuery = "select serial,id_person,p_nom,s_nom,p_ape,s_ape from personas,empleados  where serial=serial_empleado"+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
