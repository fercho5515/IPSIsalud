...
<%@page import="pac.conexion" %>
  ...
  <%                        request.setCharacterEncoding("UTF-8");
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("ideps","eps"+where+"");
                          //     System.out.println("total "+total);
                            ...
                            strQuery = "select indice,ideps,nombre,direccion,telefono,nit,ciudad,tipo from eps"+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
                         ...
                         //   total = conexiondb.countRec("ideps","eps"+where+"");
                           //    System.out.println("total2 "+total);
                            ...
                            while(rs.next()){
                                ...
                                json = json + "\n{";
                                json = json + "\"id\":\""+rs.getInt("indice")+"\",";
                                json = json + "\"cell\":["+rs.getInt("indice")+"";
                                json = json + ",\""+rs.getString("ideps")+"\"";                                
                                json = json + ",\""+rs.getString("nombre")+"\"";
                                json = json + ",\""+rs.getString("direccion")+"\"";
                                json = json + ",\""+rs.getString("telefono")+"\"";
                                json = json + ",\""+rs.getString("nit")+"\"";
                                json = json + ",\""+rs.getString("ciudad")+"\"";
                                json = json + ",\""+rs.getString("tipo")+"\"]";
                                json = json + "}";
                                rc=true; 
                            }
