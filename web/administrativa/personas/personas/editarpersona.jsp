...
<script type="text/javascript" language="javascript">
    ...
    function validacreaemp(){
          ...
          //ciudad
            ...
            //eps epsemp
            var epss =document.getElementById("epsemp");
            var epssd=epss.options[epss.selectedIndex].value;
 ...
 $("#filef").change(function() {
   ...
   jQuery("#listaPerso").jqGrid({
   	url:'personas/personas/carga_personas.jsp?q=2',
	datatype: "json",
	...
	onSelectRow: function(id){  
                     $("#divdatos").load("personas/personas/editabasepersona.jsp?dato="+id);                     
                                 }	
});
