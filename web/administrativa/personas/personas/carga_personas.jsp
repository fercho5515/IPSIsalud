<%-- 
    Document   : carga_personas
    Created on : 12/04/2013, 02:49:31 PM
    Author     : EMMANUEL
--%>
...
<%@page import="pac.cla" %>
  ...
  <%                        request.setCharacterEncoding("UTF-8");
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("serial", "personas where serial!='"+cl.idsuper()+"' "+where);
                          //     System.out.println("total "+total);
                            ...
                            strQuery = "select serial,id_person,p_nom,s_nom,p_ape,s_ape from personas where serial!='"+cl.idsuper()+"' "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
