...
jQuery("#listaPersoEmple").jqGrid({
   	url:'personas/pacientes/carga_personas_no_pacientes.jsp?q=2',
	datatype: "json",
	...
	onSelectRow: function(id){  
                     $("#divdatos").load("personas/pacientes/editabasepersona3.jsp?dato="+id);
...
<form name="form_crea_emp" id="form_crea_emp" target="upload_target_emp" action="personas/pacientes/nuevopaciente.jsp" method="post"  onsubmit="return validacreapaciente();"> 
