...
function cambiaeps(){
 ...
 <body>  
    ...
    <br><center><a href="../index.jsp">volver</a></center>
     ...
     %>         
    <form name="form_edita_pac" id="form_edita_pac" target="upload_target_pac" action="personas/pacientes/edita_paciente.jsp" method="post"  onsubmit="return validacreapaciente();" enctype="multipart/form-data" >     
...
<td rowspan="6" style="width:20%">
    <img src="../imagenes/fotos/<% out.print(datos[16]); %>" name="previewer" id="previewer" alt="imagen no encontrada" height="150px" width="auto"  onerror="this.src='../imagenes/fotos/paciente.png'">
