<%-- 
    Document   : carga_personas_no_empleadas
    Created on : 23/04/2013, 05:45:44 PM
    Author     : EMMANUEL
--%>
...
<%@page import="pac.conexion" %>
  ...
  <%                        request.setCharacterEncoding("UTF-8");
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("serial", "personas where serial not in (select serial_empleado from empleados) "+where+"");
                          //     System.out.println("total "+total);
                            ...
                            strQuery = "select serial,id_person,p_nom,s_nom,p_ape,s_ape from personas  where  serial not in (select serial_empleado from empleados) "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
