<%-- 
    Document   : carga_empleados
    Created on : 23/04/2013, 10:14:52 PM
    Author     : EMMANUEL
--%>
...
<%@page import="pac.cla" %>
  ...
  <%  request.setCharacterEncoding("UTF-8");
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("serial", "personas,empleados  where serial=serial_empleado and serial!='"+cl.idsuper()+"' "+where+"");
                          //     System.out.println("total "+total);
                            ...
                            strQuery = "select serial,id_person,p_nom,s_nom,p_ape,s_ape from personas,empleados  where serial=serial_empleado and serial!='"+cl.idsuper()+"' "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
                            // System.out.println(strQuery);
                            
                            rs = conexiondb.Consulta(strQuery);
                        
                           //  total = conexiondb.countRec("serial", "personas,empleados  where serial=serial_empleado"+where+"");
