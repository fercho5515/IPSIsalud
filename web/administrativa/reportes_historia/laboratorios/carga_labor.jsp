...
<%@page import="pac.conexion" %>
  ...
  <%                        request.setCharacterEncoding("UTF-8");
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("l.serial","  personas p,personas p2,consulta_medica c,labs_sol l,cups cu where l.id_consulta=c.id_consulta and c.serial_historia=p.serial and c.id_medico=p2.serial and cu.id_cups=l.id_lab "+where+"");
