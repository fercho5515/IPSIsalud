...
<%@page import="pac.conexion" %>
  ...
  <%                        request.setCharacterEncoding("UTF-8");
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("l.serial","  personas p,personas p2,consulta_medica c,labs_sol l,cups cu where l.id_consulta=c.id_consulta and c.serial_historia=p.serial and c.id_medico=p2.serial and cu.id_cups=l.id_lab and c.id_consulta='"+consulta+"' "+where+"");
                            ...
                            strQuery = "select l.serial as id,p.p_nom as p1,p.s_nom as p2,p.p_ape as p3,p.s_ape as p4,p.id_person as ced,cu.descripcion as descri,p2.p_nom as pp1,p2.s_nom as pp2,p2.p_ape as pp3,p2.s_ape as pp4,date(c.fecha) as fecha from personas p,personas p2,consulta_medica c,labs_sol l,cups cu where l.id_consulta=c.id_consulta and c.serial_historia=p.serial and c.id_medico=p2.serial and cu.id_cups=l.id_lab and c.id_consulta='"+consulta+"' "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
