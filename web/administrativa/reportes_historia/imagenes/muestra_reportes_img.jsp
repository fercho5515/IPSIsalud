...
<html>
    ...
    <br><center><a href="../index.jsp">volver</a></center>
         ...
         String sql0="select p.serial from consulta_medica c,personas p,imgs_sol s where s.id_consulta=c.id_consulta and c.serial_historia=p.serial and s.serial='"+pide+"'";
...
%>      <center>
        ...
        <div id="datos_per" name="datos_per" style="text-align:left">
            ...
            <center><h2>DATOS DE IMAGEN</h2></center>
               <%             String datrs0[] = new String[6];
                        datrs0[0]="";datrs0[1]="";datrs0[2]="";datrs0[3]="";datrs0[4]="";datrs0[5]="";
                        String sqlrs0="select cu.cup_verdadero,cu.descripcion,p_nom,s_nom,p_ape,s_ape,ls.fecha_soli,ls.descri,ls.archi_img from imgs_sol ls,personas p,consulta_medica c,cups cu where ls.id_consulta=c.id_consulta and c.id_medico=p.serial and cu.id_cups=ls.id_img and ls.serial='"+pide+"'";
   ...
   %>
         ...
         <%             String datrs[] = new String[4];
                        ...
                        String sqlrs="select p_nom,s_nom,p_ape,s_ape,rs.fecha,rs.reporte,rs.ruta from resu_img rs,personas p,consulta_medica c where rs.id_consulta=c.id_consulta and c.id_medico=p.serial and id_sol_ima='"+pide+"';";
   ...
   %>
         <table border="0"  style="width:100%">
          ...
          <%  if(datrs[3]==null || datrs[3].compareTo("")==0 || datrs[3].compareTo("null")==0){
            ...
            <a href='../../../archivos/imagenes/<% out.print(datrs[3]);  %>' >Ver</a> 
           ...
           <br>
            ...
            <a href='../../../archivos/imagenes/<% out.print(datrs0[5]);  %>' >ver</a> 
