<%-- 
    Document   : carga_soli_np
    Created on : 18/11/2013, 08:12:25 PM
    Author     : servidor
--%>
  ...
  <%                        request.setCharacterEncoding("UTF-8");
                            ...
                            if(busca.compareTo("true")==0){
                                        ...
                                        try {
                                             ...
                                             for(int i=0;i<Integer.parseInt(""+msg.size());i++){   ///ago un ciclo para todad las restricciones
                                                ...
                                                else if(campo.compareTo("ced2")==0){campo="p2.id_person";}
                         ...
                         //  System.out.println(where);
                            ...
                            /*-----------------------------------------------------------------------------------------------------------*/
                              ...
                              total = conexiondb.countRec("s.id_soli_no_post","  personas p,personas p2,consulta_medica c,soli_no_post s where s.cod_consulta=c.id_consulta and c.serial_historia=p.serial and c.id_medico=p2.serial "+where+" ");
                            ...
                            strQuery = "select s.id_soli_no_post as id,date(c.fecha) as fecha,p.p_nom as p1,p.s_nom as p2,p.p_ape as p3,p.s_ape as p4,p.id_person as ced,p2.p_nom as pp1,p2.s_nom as pp2,p2.p_ape as pp3,p2.s_ape as pp4,p2.id_person as ced2 from personas p,personas p2,consulta_medica c,soli_no_post s where s.cod_consulta=c.id_consulta and c.serial_historia=p.serial and c.id_medico=p2.serial "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
