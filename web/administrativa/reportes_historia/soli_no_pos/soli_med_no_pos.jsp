<%-- 
    Document   : soli_diag_no_post
    Created on : 9/11/2013, 06:23:36 PM
    Author     : servidor
--%>
    ...
    <head>
	 ...
	 <link rel="shortcut icon" href="../../imagenes/fotos/favicon.ico">
        <style type="text/css">
              ...
              #tablap{border:1px #000 solid;
                       -webkit-border-radius: 10px;
                       -moz-border-radius: 10px;
                       border-radius: 10px;}
              #tdp{border:1px #000 solid; }         
              </style>
...
<tr><td id="tdp" name="tdp">&nbsp;&nbsp;&nbsp;Nombre Generico<br/> <center><label><% out.print(daatics[2]); %></label></center></td>
    <td id="tdp" name="tdp">&nbsp;&nbsp;&nbsp;Nombre Generico<br/> <center><label><% out.print(daatics[5]); %></label></center></td></tr>
<tr><td id="tdp" name="tdp" style="border-radius: 0px 0px 0px 10px;">&nbsp;&nbsp;&nbsp;Presentación y concentración<br/> <center><label><% out.print(daatics[3]); %></label></center></td>
    <td id="tdp" name="tdp">&nbsp;&nbsp;&nbsp;Presentación y concentración<br/> <center><label><% out.print(daatics[6]); %></label></center></td></tr>
...
<table id="tablap" name="tablap" style="width:100%" border="1">
   ...
   <tr id="tdi" name="tdi" >
     ...
     <td id="tdp" name="tdp" style="width:22%"><center><label><% out.print(daatics[18]); %></label></center></td>
       <td id="tdp" name="tdp" style="width:12%"><center><label><% out.print(daatics[19]); %></label></center></td>
       <td id="tdp" name="tdp" style="width:13%"><center><label><% out.print(daatics[20]); %></label></center></td>
       <td id="tdp" name="tdp" style="width:12%"><center><label><% out.print(daatics[21]); %></label></center></td>
       <td id="tdp" name="tdp" style="width:13%"><center><label><% out.print(daatics[22]); %></label></center></td>
       <td id="tdp" name="tdp" style="width:12%"><center><label><% out.print(daatics[23]); %></label></center></td>
       <td id="tdp" name="tdp" style="width:13%"><center><label><% out.print(daatics[24]); %></label></center></td>
   </tr>
   <tr id="tdi1" name="tdi1" >
       <td id="tdp" name="tdp" style="width:3%"><center>2</center></td>
       <td id="tdp" name="tdp" style="width:22%"><center><label><% out.print(daatics[25]); %></label></center></td>
       <td id="tdp" name="tdp" style="width:12%"><center><label><% out.print(daatics[26]); %></label></center></td>
       <td id="tdp" name="tdp" style="width:13%"><center><label><% out.print(daatics[27]); %></label></center></td>
       <td id="tdp" name="tdp" style="width:12%"><center><label><% out.print(daatics[28]); %></label></center></td>
       <td id="tdp" name="tdp" style="width:13%"><center><label><% out.print(daatics[29]); %></label></center></td>
       <td id="tdp" name="tdp" style="width:12%"><center><label><% out.print(daatics[30]); %></label></center></td>
       <td id="tdp" name="tdp" style="width:13%"><center><label><% out.print(daatics[31]); %></label></center></td>
   </tr>
   <tr  id="tdi2" name="tdi2" >
       <td id="tdp" name="tdp" style="width:3%;border-radius: 0px 0px 0px 10px;"><center>3</center></td>
       <td id="tdp" name="tdp" style="width:22%"><center><label><% out.print(daatics[32]); %></label></center></td>
       <td id="tdp" name="tdp" style="width:12%"><center><label><% out.print(daatics[33]); %></label></center></td>
       <td id="tdp" name="tdp" style="width:13%"><center><label><% out.print(daatics[34]); %></label></center></td>
       <td id="tdp" name="tdp" style="width:12%"><center><label><% out.print(daatics[35]); %></label></center></td>
       <td id="tdp" name="tdp" style="width:13%"><center><label><% out.print(daatics[36]); %></label></center></td>
       <td id="tdp" name="tdp" style="width:12%"><center><label> <% out.print(daatics[37]); %></label></center></td>
       <td id="tdp" name="tdp" style="width:13%;border-radius: 0px 0px 10px 0px;"><center><label><% out.print(daatics[38]); %></label></center></td>
   </tr>
     ...
     <td id="tdp" name="tdp" style="border-radius: 10px 10px 0px 0px;" >
         <table style="width:100%" border="0">
                                             <tr> 
                                                  ...
                                                  <td style="width:5%"><label><% if(daatics[8].compareTo("0")==0){out.print("Si");}else{out.print("No");}  %> </label></td> 
                                               </tr>
         </table>
     </td >
</tr>
     ...
     <td id="tdp" name="tdp" >
         <table style="width:100%" border="0">
                                             <tr> 
                                                  ...
                                                  <td style="width:5%"><label><% if(daatics[9].compareTo("0")==0){out.print("Si");}else{out.print("No");}  %> </label></td>
                                             </tr>
         </table>
     </td>
</tr>
     ...
     <td id="tdp" name="tdp" >
         <table style="width:100%" border="0">
                                             <tr> 
                                                  ...
                                                  <td style="width:5%"><label><% if(daatics[10].compareTo("0")==0){out.print("Si");}else{out.print("No");}  %> </label></td>
                                             </tr>
         </table>
     </td>
</tr>
     ...
     <td id="tdp" name="tdp" >
         <table style="width:100%" border="0">
                                             <tr> 
                                                  ...
                                                  <td style="width:5%"><label><% if(daatics[11].compareTo("0")==0){out.print("Si");}else{out.print("No");}  %> </label></td>
                                             </tr>
         </table>
     </td>
</tr>
     ...
     <td id="tdp" name="tdp" >
         <table style="width:100%" border="0">
                                             <tr> 
                                                  ...
                                                  <td style="width:5%"><label><% if(daatics[12].compareTo("0")==0){out.print("Si");}else{out.print("No");}  %> </label></td>
                                             </tr>
         </table>
     </td>
</tr>
     ...
     <td id="tdp" name="tdp" style="border-radius: 0px 0px 10px 10px;" >
         <table style="width:100%" border="0">
                                             <tr> 
                                                  ...
                                                  <td style="width:5%"><label><% if(daatics[13].compareTo("0")==0){out.print("Si");}else{out.print("No");}  %> </label></td>
                                             </tr>
         </table>
     </td>
</tr>
