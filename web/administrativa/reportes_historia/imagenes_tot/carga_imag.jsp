...
<%@page import="pac.conexion" %>
  ...
  <%                        request.setCharacterEncoding("UTF-8");
                         ...
                         //  System.out.println(where);
                            ...
                            int total0=0;
                            String cuenta = "select distinct(co.id_consulta) as id from agenda a,procedimientos_tari p,cups c,consulta_medica co,personas per,imgs_sol l where co.id_consulta=a.id_consulta and a.id_procedimiento=p.idprocedimientos_tari and p.cod_cups=c.id_cups   and (a.id_permiso='1' or a.id_permiso='2' or a.id_permiso='3') and co.id_consulta=l.id_consulta and co.id_estado_consulta='3' and co.serial_historia=per.serial "+where+" ";
                            ResultSet rs0c = null;
