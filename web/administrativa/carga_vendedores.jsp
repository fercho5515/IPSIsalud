<%-- 
    Document   : carga_vendedores
    Created on : 14/03/2013, 06:42:34 PM
    Author     : EMMANUEL
--%>
...
<%@page import="pac.conexion" %>
  ...
  <%               request.setCharacterEncoding("UTF-8");
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("id_vendedor", "vendedores where cod_distri='"+request.getParameter("id")+"'"+where+"");
                            ...
                            strQuery = "select id_vendedor,cedula,nombres,apellidos,telefono,celular,direccion from vendedores where cod_distri='"+request.getParameter("id")+"'"+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
    //   System.out.println(strQuery);
                          ...
                          //  total = conexiondb.countRec("id_vendedor", "vendedores where cod_distri='"+request.getParameter("id")+"'"+where+"");
                            ...
                            while(rs.next()){
                                ...
                                json = json + "\n{";
                                json = json + "\"id\":\""+rs.getInt("id_vendedor")+"\",";
                                json = json + "\"cell\":["+rs.getInt("id_vendedor")+"";
                                json = json + ",\""+rs.getString("cedula")+"\"";
                                json = json + ",\""+rs.getString("nombres")+"\"";  
                                json = json + ",\""+rs.getString("apellidos")+"\"";
                                json = json + ",\""+rs.getString("telefono")+"\"";
                                json = json + ",\""+rs.getString("celular")+"\"";
