                         ...
                         //   System.out.println(strQuery);
                           ...
                           // total = conexiondb.countRec("tm.id_tari", " medicamentos m,unidad_medida um,forma_farmaceutica ff,tari_med tm,lab_farmaceutico lf, tarifarios t  where lf.idlab_farmaceutico=tm.id_laboratorio and um.id_unidad_medida=m.unidad_medida and ff.id_forma_farmaceutica=m.forma_farmaceutica and tm.id_med=m.serial and t.id_tarifarios=tm.id_tari   "+where+"");
                            ...
                            while(rs.next()){
                                ...
                                json = json + ",\""+rs.getString("id_med")+"\"";
                                json = json + ",\""+rs.getString("id_laboratorio")+"\"]";
                                json = json + "}";
                                idu=idu+1;
                                rc=true;
                            }
