...
<%
    ...
    total = conexiondb.countRec("c.id_comida", "comida c where c.id_hora_comida='"+id+"' " + where + "");
    ...
    strQuery = "SELECT c.id_comida as id,c.descripcion as descr,c.id_hora_comida as id_hc FROM comida c where c.id_hora_comida='"+id+"' " + where + " ORDER BY " + sidx + " " + sord + " LIMIT " + start + " , " + limit;
    //out.print(strQuery);
