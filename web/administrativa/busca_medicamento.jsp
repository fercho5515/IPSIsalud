...
<%@page import="pac.conexion" %>
  ...
  request.setCharacterEncoding("UTF-8");         
                       ...
                       //    System.out.println(where);
                            ...
                            total = conexiondb.countRec("serial", "medicamentos where 1=1"+where+"");
                      //     out.print("1");
                            if( total>0 ) {
                            ...
                            strQuery = "select m.serial,m.cum,m.titular,m.producto,m.cantidad,m.unidad_medida as d1,m.forma_farmaceutica as d2,m.descripcion_comercial from medicamentos m where 1=1"+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
                            System.out.print("total==>"+total+"start==>"+start+"==>"+"limit==>"+limit+strQuery+"fin");
                            
                            rs = conexiondb.Consulta(strQuery);
                            
                           
                           // total = conexiondb.countRec("m.serial", "medicamentos m,unidad_medida um,forma_farmaceutica ff where um.id_unidad_medida=m.unidad_medida and ff.id_forma_farmaceutica=m.forma_farmaceutica"+where+"");
