...
<%@page import="pac.conexion" %>
  ...
  request.setCharacterEncoding("UTF-8");         
                        ...
                        //   System.out.println(where);
                            ...
                            total = conexiondb.countRec("m.serial", "medicamentos m,unidad_medida um,forma_farmaceutica ff, tari_med tm, med_paq_int mi, tarifarios t, lab_farmaceutico l where um.id_unidad_medida=m.unidad_medida and ff.id_forma_farmaceutica=m.forma_farmaceutica and l.idlab_farmaceutico=tm.id_laboratorio and mi.id_lab=lf.idlab_farmaceutico and tm.id_med=mi.cod_med and tm.id_tari=mi.cod_tari and tm.id_tari=t.id_tarifarios and tm.id_med=m.serial and mi.cod_paq_int='"+session.getAttribute("id_paq")+"' "+where+"");
                            ...
                            strQuery = "select m.serial,m.cum,m.cod_atc,m.producto,m.concentracion,um.descripcion as d1,ff.descripcion as d2,m.presentacion,lf.nombre as lab  from medicamentos m,unidad_medida um,forma_farmaceutica ff, tari_med tm, med_paq_int mi, tarifarios t, lab_farmaceutico lf  where lf.idlab_farmaceutico=tm.id_laboratorio and um.id_unidad_medida=m.unidad_medida and ff.id_forma_farmaceutica=m.forma_farmaceutica and tm.id_med=mi.cod_med and tm.id_tari=mi.cod_tari and tm.id_tari=t.id_tarifarios and mi.id_lab=lf.idlab_farmaceutico and tm.id_med=m.serial and mi.cod_paq_int='"+session.getAttribute("id_paq")+"' "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
                           //out.print(strQuery);
                            
                            rs = conexiondb.Consulta(strQuery);
                            
                     //       total = conexiondb.countRec("m.serial", "medicamentos m,unidad_medida um,forma_farmaceutica ff, tari_med tm, med_paq_int mi, tarifarios t, lab_farmaceutico l where um.id_unidad_medida=m.unidad_medida and ff.id_forma_farmaceutica=m.forma_farmaceutica and l.idlab_farmaceutico=tm.id_laboratorio and tm.id_med=mi.cod_med and tm.id_tari=mi.cod_tari and tm.id_tari=t.id_tarifarios and tm.id_med=m.serial and mi.cod_paq_int='"+session.getAttribute("id_paq")+"' "+where+"");
