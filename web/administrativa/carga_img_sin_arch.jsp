<%-- 
    Document   : carga_img_sin_arch
    Created on : 16/08/2013, 07:52:36 PM
    Author     : Emmanuel
--%>
  ...
  <%               request.setCharacterEncoding("UTF-8");
                         ...
                         //  System.out.println(where);
                            ...
                            /*-----------------------------------------------------------------------------------------------------------*/
                             ...
                             total = conexiondb.countRec("i.serial", "imgs_sol i,consulta_medica c,personas p1,personas p2,cups cu where i.id_consulta=c.id_consulta and c.serial_historia=p1.serial and c.id_medico=p2.serial and i.id_img=cu.id_cups "+where+"");
                            ...
                            strQuery = "select i.serial,date(i.fecha_soli) as fecha,concat(p1.p_nom,' ',p1.s_nom,' ',p1.p_ape,' ',p1.s_ape) as paciente, p1.id_person as cedpaciente,concat(p2.p_nom,' ',p2.s_nom,' ',p2.p_ape,' ',p2.s_ape) as empleado, p2.id_person as cedemple,cu.descripcion,i.archi_img from imgs_sol i,consulta_medica c,personas p1,personas p2,cups cu where i.id_consulta=c.id_consulta and c.serial_historia=p1.serial and c.id_medico=p2.serial and i.id_img=cu.id_cups "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
