...
<%@page import="pac.conexion" %>
  ...
  <%                        request.setCharacterEncoding("UTF-8");
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("serial", "personas"+where+"");
                          //     System.out.println("total "+total);
                            ...
                            strQuery = "select serial,id_person,p_nom,s_nom,p_ape,s_ape from personas"+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
