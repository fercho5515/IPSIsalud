...
<%@page import="pac.conexion" %>
  ...
  <%
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("tp.id_tarifario", "procedimientos_tari pt, cups cu,tarifarios t,tari_proced tp where pt.cod_cups=cu.id_cups and tp.id_proced=pt.idprocedimientos_tari and t.id_tarifarios=tp.id_tarifario "+where+"");
                            ...
                            strQuery = "select tp.id_tarifario,tp.id_proced,cu.cup_verdadero,pt.codigo_maipos,pt.descripcion as d1,t.nombre as n1,tp.precio from procedimientos_tari pt, cups cu,tarifarios t,tari_proced tp where pt.cod_cups=cu.id_cups and tp.id_proced=pt.idprocedimientos_tari and t.id_tarifarios=tp.id_tarifario "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
                          ...
                          //  total = conexiondb.countRec("tp.id_tarifario", "procedimientos_tari pt, cups cu,tarifarios t,tari_proced tp where pt.cod_cups=cu.id_cups and tp.id_proced=pt.idprocedimientos_tari and t.id_tarifarios=tp.id_tarifario "+where+"");
                            ...
                            while(rs.next()){
                                ...
                                json = json + "\"id\":\""+cont+"\",";
                                json = json + "\"cell\":["+cont+"";
                                json = json + ",\""+rs.getString("id_tarifario")+"\"";
                                json = json + ",\""+rs.getString("id_proced")+"\"";
