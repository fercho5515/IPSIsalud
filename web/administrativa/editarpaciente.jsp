...
jQuery("#listaPersoEmple").jqGrid({
	...
	onSelectRow: function(id){  
                     $("#divdatos").load("editabasepersona4.jsp?dato="+id);
...
<form name="form_crea_pac" id="form_crea_pac" target="upload_target_pac" action="edita_paciente.jsp" method="post"  onsubmit="return validacreapaciente();" enctype="multipart/form-data"> 
