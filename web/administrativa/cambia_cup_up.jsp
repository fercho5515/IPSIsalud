...
<html>
    ...
    <body>
         ...
         //out.println("Sesion==>"+sesion.getAttribute("cup_update"));
                        ...
                        //out.print(datos3[0]);
                        String sql5="select cup_verdadero from cups c,procedimientos_tari p where p.cod_cups=c.id_cups and idprocedimientos_tari='"+sesion.getAttribute("cup_update")+"';";
                        String datos5[]=new String [1];
                        ResultSet resu5=ba.consultas(sql5);
                        try{
                             while (resu5.next()||resu5!=null) { 
                                         datos5[0]=resu5.getString(1);
                                         }}
                        catch(SQLException e){}
                        catch(Exception ex){datos5[0]=""+'0';}
                        //out.print(datos5[0]);
                        if(datos[0]==null){
                                        %>
