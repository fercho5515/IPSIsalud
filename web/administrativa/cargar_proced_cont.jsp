...
<%@page import="pac.conexion" %>
  ...
  <%                        request.setCharacterEncoding("UTF-8");
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("tp.id_tarifario","procedimientos_tari pt, cups cu,tarifarios t,tari_proced tp,procedimientos_cont pc where pt.cod_cups=cu.id_cups and tp.id_proced=pt.idprocedimientos_tari and t.id_tarifarios=tp.id_tarifario and pc.cod_activ=tp.id_proced and pc.cod_tarifario=tp.id_tarifario and pc.id_contrato='"+(String)session.getAttribute("id_contratacion")+"' "+where+"");
                         //   System.out.println("total "+total);
                            ...
                            strQuery = "select tp.id_tarifario,cu.cup_verdadero,pt.codigo_maipos,pt.descripcion as d1,t.nombre as n1,tp.precio,pc.porcentaje from procedimientos_tari pt, cups cu,tarifarios t,tari_proced tp,procedimientos_cont pc where pt.cod_cups=cu.id_cups and tp.id_proced=pt.idprocedimientos_tari and t.id_tarifarios=tp.id_tarifario and pc.cod_activ=tp.id_proced and pc.cod_tarifario=tp.id_tarifario and pc.id_contrato='"+(String)session.getAttribute("id_contratacion")+"' "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
                         //   System.out.println(strQuery);
                           ...
                           //    System.out.println("total2 "+total);
                            ...
                            while(rs.next()){
                                ...
                                json = json + "\n{";
                                json = json + "\"id\":\""+rs.getInt("id_tarifario")+"\",";
                                json = json + "\"cell\":["+rs.getInt("id_tarifario")+"";
