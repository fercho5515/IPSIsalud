<%-- 
    Document   : contenedor_antecedentes
    Created on : 13-abr-2013, 17:36:55
    Author     : Fercho
--%>
<!doctype html>
<html lang="es">
...
function cambiaPestanaAntecedentes(pestanaAnte){
                           ...
                           if(pestanaAnte==1){$("#tabs-antecedentes").load("crear_tipo_antecedente.jsp");}
                           else if(pestanaAnte==2){$("#tabs-antecedentes").load("crear_antecedente.jsp");}
