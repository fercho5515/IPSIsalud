...
<%@page import="pac.conexion" %>
  ...
  <%                        request.setCharacterEncoding("UTF-8");
                 ...
                 //System.out.println("total ==>       personas pe,pacientes pa,afiliados_cont ac where pe.serial=pa.serial_persona and ac.serial_paciente=pa.serial_persona and ac.id_cont='"+session.getAttribute("tarifario")+"' "+where+"");
                            total = conexiondb.countRec("distinct id_paciente", "from agenda ag, personas pe where pe.serial=ag.id_paciente and fecha=curdate() and id_estado=3 "+where);
                            ...
                            strQuery = "select distinct id_paciente,p_nom,s_nom,p_ape,s_ape,fecha from agenda ag, personas pe where pe.serial=ag.id_paciente and fecha=curdate() and id_estado=3 "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
                           ...
                           //    System.out.println("total2 "+total);
                            ...
                            while(rs.next()){
                                ...
                                json = json + "\n{";
                                json = json + "\"id\":\""+rs.getInt("id_paciente")+"\",";
                                json = json + "\"cell\":["+rs.getInt("id_paciente")+"";
