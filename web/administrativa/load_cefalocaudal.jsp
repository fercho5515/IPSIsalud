...
<%@page import="pac.conexion" %>
  ...
  request.setCharacterEncoding("UTF-8");         
                     ...
                     //      System.out.println(where);
                            ...
                            total = conexiondb.countRec("pc.id_parte", "partes_cuerpo as pc "+where+"");
                            ...
                            strQuery = "select pc.id_parte as id,pc.descripcion as descr FROM partes_cuerpo as pc "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
                            //out.print(strQuery);
