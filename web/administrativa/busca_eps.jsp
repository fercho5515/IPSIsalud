...
<%   
   ...
   // System.out.println(where);
    ...
    total = conexiondb.countRec("ideps", "eps  where ideps=ideps" + where + "");
    ...
    strQuery = "select ideps,nit,nombre,tipo from eps  where ideps=ideps" + where + " ORDER BY " + sidx + " " + sord + " LIMIT " + start + " , " + limit;
