...
<%@page import="pac.conexion" %>
  ...
  <%
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("pt.idprocedimientos_tari", "cups c,procedimientos_tari pt, tari_proced tp where pt.cod_cups=c.id_cups and tp.id_proced=pt.idprocedimientos_tari and tp.id_tarifario='"+(String)session.getAttribute("tarifario")+"'"+where+"");
                            ...
                            strQuery = "select pt.idprocedimientos_tari,c.cup_verdadero,pt.codigo_maipos,pt.descripcion as d1,tp.precio,tp.id_tarifario as idt from cups c,procedimientos_tari pt, tari_proced tp where pt.cod_cups=c.id_cups and tp.id_proced=pt.idprocedimientos_tari and tp.id_tarifario='"+(String)session.getAttribute("tarifario")+"'"+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
