            ...
            $('#form_med_cont').submit(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $('#div_resu_insertmed2').html(data);    
                        setTimeout ('recargamedcont()',500);
                        $.modal.close(); 
                    }                             
                })  
                return false;
...
%>
    ...
    <br><center><a href="../index.jsp">volver</a></center>
         ...
         String sql="select m.serial,m.cum,m.cod_atc,m.producto,m.concentracion,um.descripcion as d1,ff.descripcion as d2,m.presentacion,lf.nombre as lab,tm.precio,t.nombre as tari, t.id_tarifarios,lf.idlab_farmaceutico from medicamentos m,unidad_medida um,forma_farmaceutica ff,lab_farmaceutico lf, tari_med tm,tarifarios t where um.id_unidad_medida=m.unidad_medida and ff.id_forma_farmaceutica=m.forma_farmaceutica and tm.id_med=m.serial and t.id_tarifarios=tm.id_tari and tm.id_laboratorio= lf.idlab_farmaceutico and tm.id_med='"+med+"' and tm.id_tari='"+tarif+"' and tm.id_laboratorio='"+labo+"';";
       //  out.print(sql); 
         ResultSet resu=null;
        ...
        ba.cerrar();
        %>
<div id="div_resu_insertmed2"></div>
<form id="form_med_cont" name="form_med_cont" method="post" action="insert_medictari_cont.jsp">
...
<table style="height:100%;width:80%;padding-top:5px" align="center" border="0">
    ...
    <input type="hidden" id="id_tari" name="id_tari" value="<%out.print(datos[11]);%>"><br>
    <input type="hidden" id="id_labo" name="id_labo" value="<%out.print(datos[12]);%>"><br>
    ...
    <tr><td>
        ...
        <tr><td>
            ...
            <input type="text" id="precio" name="precio" size="100" value="<%out.print(datos[9]);%>"><br>
        </td></tr>
        <tr><td>
            <label>TARIFARIO: </label>
        </td><td>
            <input type="text" id="precio" name="precio" size="100" value="<%out.print(datos[10]);%>"><br>
        </td></tr>
        <tr><td>
            <label>PORCENTAJE: </label>
        </td><td>
            <input type="text" id="porcentaje" name="porcentaje" size="100"><br>
        </td></tr>
