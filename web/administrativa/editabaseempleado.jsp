...
<td rowspan="6" style="width:20%">
    <img src="../imagenes/fotos/<% out.print(datos[16]); %>" name="previewer" id="previewer" alt="imagen no encontrada" height="150px" width="100%"  onerror="this.src='../imagenes/fotos/medico.png'">
