<%-- 
    Document   : carga_distribuidor
    Created on : 14/03/2013, 11:58:24 AM
    Author     : EMMANUEL
--%>
...
<%@page import="pac.conexion" %>
  ...
  <%                        request.setCharacterEncoding("UTF-8");
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("id_distri", "distribuidores"+where+"");
                          //     System.out.println("total "+total);
                            ...
                            strQuery = "select id_distri,nombre,direccion,telefono,celular,camara_comercio,direccion,nit from distribuidores"+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
                           ...
                           //    System.out.println("total2 "+total);
                            ...
                            while(rs.next()){
                                ...
                                json = json + "\n{";
                                json = json + "\"id\":\""+rs.getInt("id_distri")+"\",";
                                json = json + "\"cell\":["+rs.getInt("id_distri")+"";
                                ...
                                json = json + ",\""+rs.getString("nit")+"\"";
                                json = json + ",\""+rs.getString("camara_comercio")+"\"]";
                                json = json + "}";
                                rc=true;
                            }
