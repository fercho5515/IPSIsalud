...
<%      
        ...
        if (operador.equals("edit")) {
            try {
                ...
                ba.ConectaDb();
                sql = "UPDATE `tari_proced` SET `precio`='" + request.getParameter("precio") + "' where id_tarifario='" + request.getParameter("idt") + "' and  id_proced='" + request.getParameter("id") + "';";
            ...
            try {
                conecta_bd ba = new conecta_bd();
                ba.ConectaDb();
                sql = "DELETE FROM `tari_proced` WHERE id_tarifario='" + request.getParameter("idt") + "' and  id_proced='" + request.getParameter("id") + "';";
                //out.print(sql);
                if (ba.transaccion(sql)) {
                    obj.put("res", "1");
