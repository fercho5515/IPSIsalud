<%-- 
    Document   : mostrar_proced3
    Created on : 26-jun-2013, 16:39:18
    Author     : Andrea
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript" language="javascript">
            $('#form_tiempo_veces').submit(function() {
       
                var por= document.getElementById("tiempo").value;               
                if( por == null || por.length == 0 || /^\s+$/.test(por) ) {
                    alert('Digite el tiempo');
                    return false;  
                } 
                var por= document.getElementById("cantidad").value;               
                if( por == null || por.length == 0 || /^\s+$/.test(por) ) {
    ...
    <%
      ...
      ///  out.print(sql);
        ...
        ba.cerrar();
    %>
    <dvi id="div_porcentajeresp" name="div_porcentajeresp"></dvi>       
    <form id="form_tiempo_veces" name="form_tiempo_veces" method="post" action="insert_proctari_paq.jsp">
        <table style="height:100%;width:80%;padding-top:5px" align="center">
            ...
            <tr><td>
                    <label>Activar para evento: </label>
                </td><td>
