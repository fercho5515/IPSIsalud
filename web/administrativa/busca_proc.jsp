<%-- 
    Document   : busca_proc
    Created on : 10-abr-2013, 17:31:23
    Author     : Fercho
--%>
...
<%@page import="pac.conexion" %>
  ...
  <%
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("pt.idprocedimientos_tari", "procedimientos_tari pt, cups cu where pt.cod_cups=cu.id_cups"+where+"" );
                            ...
                            strQuery = "select pt.idprocedimientos_tari,cu.cup_verdadero,pt.codigo_maipos,pt.descripcion as d1 from procedimientos_tari pt, cups cu where pt.cod_cups=cu.id_cups"+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
