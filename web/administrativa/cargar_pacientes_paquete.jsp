<%-- 
    Document   : cargar_pacientes_paquete
    Created on : 09-jul-2013, 12:37:09
    Author     : Andrea
--%>
...
<%@page import="pac.conexion" %>
  ...
  <%                        request.setCharacterEncoding("UTF-8");
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("serial", " personas pe,pacientes pa,afiliados_cont ac,afiliados_pac_int ap where pe.serial=pa.serial_persona and ac.serial_paciente=pa.serial_persona and ac.id_cont='"+(String)session.getAttribute("id_contratacion")+"' and ap.id_pac_int='"+(String)session.getAttribute("id_paq")+"' and ac.serial_paciente=ap.serial_paciente  "+where+"");
                          //     System.out.println("total "+total);
                            ...
                            strQuery = "select serial,id_person,p_nom,s_nom,p_ape,s_ape,activo2 from personas pe,pacientes pa,afiliados_cont ac,afiliados_pac_int ap where pe.serial=pa.serial_persona and ac.serial_paciente=pa.serial_persona and ac.id_cont='"+(String)session.getAttribute("id_contratacion")+"' and ap.id_pac_int='"+(String)session.getAttribute("id_paq")+"' and ac.serial_paciente=ap.serial_paciente "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
                        //   System.out.println(strQuery);
                            
                            rs = conexiondb.Consulta(strQuery);
                               
                          //  total = conexiondb.countRec("serial", "personas pe,pacientes pa,afiliados_cont ac where pe.serial=pa.serial_persona and ac.serial_paciente=pa.serial_persona and ac.id_cont='"+(String)session.getAttribute("id_contratacion")+"' "+where+"");
                           //    System.out.println("total2 "+total);
                            ...
                            while(rs.next()){
                                ...
                                json = json + ",\""+rs.getString("activo2")+"\"]";
                                json = json + "}";
                                rc=true;
                            }
