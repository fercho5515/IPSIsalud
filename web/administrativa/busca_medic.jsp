...
<%@page import="pac.conexion" %>
  ...
  request.setCharacterEncoding("UTF-8");         
                      ...
                      //     out.print("1");
                            ...
                            strQuery = "select m.serial,m.cum,m.cod_atc,m.producto,m.concentracion,um.descripcion as d1,ff.descripcion as d2,m.presentacion from medicamentos m,unidad_medida um,forma_farmaceutica ff where um.id_unidad_medida=m.unidad_medida and ff.id_forma_farmaceutica=m.forma_farmaceutica"+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
