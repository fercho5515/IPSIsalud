...
<%
   ...
   // System.out.println(where);
    ...
    total = conexiondb.countRec("id_tarifarios", "tarifarios  where 10=10" + where + "");
    ...
    strQuery = "select id_tarifarios,cod_tarifario,nombre,fecha_creacion,activo from tarifarios  where 10=10" + where + " ORDER BY " + sidx + " " + sord + " LIMIT " + start + " , " + limit;
  ...
  //  total = conexiondb.countRec("id_subcie10", "sub_cie10  where cie10=cie10" + where + "");
    ...
    try {
        while (rs.next()) {
            ...
            json = json + "\n{";
            json = json + "\"id\":\"" + rs.getString("id_tarifarios") + "\",";
            json = json + "\"cell\":[" + rs.getString("id_tarifarios") + "";
            json = json + ",\"" + rs.getString("cod_tarifario") + "\"";
            json = json + ",\"" + rs.getString("nombre") + "\"";
            json = json + ",\"" + rs.getString("fecha_creacion") + "\"";
            json = json + ",\"" + rs.getString("activo") + "\"]";
            json = json + "}";
            iddiag++;
            rc = true;
        }
