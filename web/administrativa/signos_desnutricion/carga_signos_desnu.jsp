...
<%@page import="pac.conexion" %>
  ...
  <%               request.setCharacterEncoding("UTF-8");
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("id_signos", "signos_desnu "+where+"");
                            ...
                            strQuery = "SELECT id_signos,descripcion FROM signos_desnu "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
    //   System.out.println(strQuery);
                            ...
                            while(rs.next()){
                                ...
                                json = json + "\n{";
                                json = json + "\"id\":\""+rs.getInt("id_signos")+"\",";
                                json = json + "\"cell\":["+rs.getInt("id_signos")+"";
