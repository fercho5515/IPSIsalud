...
<%@page import="pac.conexion" %>
  ...
  <%               request.setCharacterEncoding("UTF-8");
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("id_sub_signos", " signos_desnu sd,sub_signos ss where sd.id_signos=ss.id_signos "+where+"");
                            ...
                            strQuery = "select ss.id_sub_signos,ss.decripcion ,ss.id_signos,sd.descripcion from signos_desnu sd,sub_signos ss where sd.id_signos=ss.id_signos "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
    //  System.out.println(strQuery);
                            ...
                            while(rs.next()){
                                ...
                                json = json + "\n{";
                                json = json + "\"id\":\""+rs.getInt("id_sub_signos")+"\",";
                                json = json + "\"cell\":["+rs.getInt("id_sub_signos")+"";
                                json = json + ",\""+rs.getString("decripcion")+"\"";
                                json = json + ",\""+rs.getString("id_signos")+"\"";
