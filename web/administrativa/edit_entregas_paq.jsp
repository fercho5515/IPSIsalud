            ...
            if (session.getAttribute("nombre") == null || session.getAttribute("clave") == null || session.getAttribute("id") == null || session.getAttribute("permiso") == null) {
                ...
                if ((bandera == 1 && a == 0) || (bandera == 0)) {
                    if (opera.compareTo("edit") == 0) {
                        String sql = "UPDATE `ips_isalud`.`afiliados_cont` SET `activo`='" + request.getParameter("activo") + "' WHERE `id_cont`='" + session.getAttribute("id_contratacion") + "' and `serial_paciente`='" + request.getParameter("id") + "';";
