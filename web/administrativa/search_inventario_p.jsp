<%-- 
    Document   : search_inventario2
    Created on : 15-nov-2013, 11:05:49
    Author     : MiPc
--%>
...
<%@page import="pac.conexion" %>
  ...
  request.setCharacterEncoding("UTF-8");         
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("m.serial", "inventario_farmacia i, medicamentos m,forma_farmaceutica ff,via_admin v,lab_farmaceutico lf ,tari_med tm,med_paq_int mi where i.cod_medicamento=m.serial and ff.id_forma_farmaceutica=m.forma_farmaceutica and v.id_via_admin=m.via_administracion and lf.idlab_farmaceutico=i.laboratorio and i.existencias > 0 and mi.id_lab=i.laboratorio and mi.cod_med=i.cod_medicamento and tm.id_med=mi.cod_med and mi.cod_tari=tm.id_tari and mi.id_lab=tm.id_laboratorio and mi.cod_paq_int='"+dato3+"' "+where+"");
                            ...
                            strQuery = "select m.serial,i.serial_inven,m.producto, m.cod_atc, m.cum,ff.descripcion as f1,v.descripcion as v1,m.concentracion,m.presentacion,i.valor_compra,i.existencias,lf.nombre as lab,i.fecha_fab,i.fecha_ven,i.ubicacion,i.lote,mi.cod_paq_int as paq from inventario_farmacia i, medicamentos m,forma_farmaceutica ff,via_admin v,lab_farmaceutico lf ,tari_med tm,med_paq_int mi where i.cod_medicamento=m.serial and ff.id_forma_farmaceutica=m.forma_farmaceutica and v.id_via_admin=m.via_administracion and lf.idlab_farmaceutico=i.laboratorio and i.existencias > 0 and mi.id_lab=i.laboratorio and mi.cod_med=i.cod_medicamento and tm.id_med=mi.cod_med and mi.cod_tari=tm.id_tari and mi.id_lab=tm.id_laboratorio and mi.cod_paq_int='"+dato3+"' "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
