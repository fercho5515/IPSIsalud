           ...
           //fecha vinculacion
            ...
            var estado=esta.options[esta.selectedIndex].text;
             ...
             if( $("#calendariovinculacion").val() == "" ){
                        document.getElementById('validacionemp').innerHTML = 'Ingrese fecha de vinculación';
 ...
 $("#filef").change(function() {
   ...
   jQuery("#listaPerso").jqGrid({
	...
	onSelectRow: function(id){  
                     $("#divdatos").load("editabaseempleado.jsp?dato="+id);   
                     $("#divpermisos").load("carga_presmisos_emp.jsp?dato="+id);
...
<form name="form_edita_emp" id="form_edita_emp" target="upload_target_emp" action="edita_empleado.jsp" method="post"  onsubmit="return validaeditaemp();" enctype="multipart/form-data" >     
...
<form name="form_crea_emp" id="form_crea_emp" target="upload_target_emp" action="nuevoempleado.jsp" method="post"  onsubmit="return validacreaempleado();" enctype="multipart/form-data" > 
        ...
        <fieldset>
         ...
         <center>
             <table>  
                 <tr><td></td></tr>
             <%
                         String sql6="select id_permi,descripcion from permisos;";
                         int bandc=0;
