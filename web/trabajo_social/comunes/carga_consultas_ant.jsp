...
<%@page import="pac.conexion" %>
  ...
  <%
                         ...
                         //  System.out.println(where);
                            ...
                            /*-----------------------------------------------------------------------------------------------------------*/
                            //
                            total = conexiondb.countRec("co.id_consulta_trabajo_social ", " agenda a,procedimientos_tari p,cups c,consulta_trabajo_social co where a.id_procedimiento=p.idprocedimientos_tari  and p.cod_cups=c.id_cups  and co.id_consulta_trabajo_social=a.id_consulta and a.id_paciente='"+session.getAttribute("serial_pacinete")+"' and co.guardado='1'  "+where+"");
                            ...
                            strQuery = "select co.id_consulta_trabajo_social,date(co.fecha_real) as fecha,c.descripcion as descripcion from agenda a,procedimientos_tari p,cups c,consulta_trabajo_social co where a.id_procedimiento=p.idprocedimientos_tari  and p.cod_cups=c.id_cups  and co.id_consulta_trabajo_social=a.id_consulta and a.id_paciente='"+session.getAttribute("serial_pacinete")+"' and co.guardado='1' "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
   //   System.out.println("carga consulta ant psico ==>"+strQuery);
                           ...
                           // total = conexiondb.countRec("co.id_consulta_trabajo_social ", " agenda a,procedimientos_tari p,cups c,consulta_trabajo_social co where a.id_procedimiento=p.idprocedimientos_tari  and p.cod_cups=c.id_cups  and co.id_consulta_trabajo_social=a.id_consulta and a.id_paciente='"+session.getAttribute("serial_pacinete")+"' and co.guardado='1'  "+where+"");
                            ...
                            while(rs.next()){
                                ...
                                json = json + "\n{";
                                json = json + "\"id\":\""+rs.getInt("id_consulta_trabajo_social")+"\",";
                                json = json + "\"cell\":["+rs.getInt("id_consulta_trabajo_social")+"";
