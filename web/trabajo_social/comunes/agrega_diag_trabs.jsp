...
<html>
    ...
    <br><center><a href="../index.jsp">volver</a></center>
        ...
        ba.ConectaDb(); 
                    ...
                    String sql="INSERT INTO `ips_isalud`.`impre_diagno_trabajo_soci` (`id_consulta_trabajo_soci`, `id_subcie`, `descrip`, `id_tipo_diagnostico`, `causa_externa`, `control`) VALUES ('"+session.getAttribute("serial_consulta")+"','"+subcie10+"','"+descrip+"','"+tipodiag+"','"+causaexte+"', now());";
