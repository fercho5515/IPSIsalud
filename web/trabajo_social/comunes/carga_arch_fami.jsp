<%-- 
    Document   : carga_arch_fami
    Created on : 30/10/2013, 06:41:49 PM
    Author     : Emmanuel
--%>
...
<%@page import="pac.conexion" %>
  ...
  <%
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("id", "archivos_consulta_trabajo_so where id_consulta='"+session.getAttribute("serial_consulta")+"'  "+where+"");
                            ...
                            strQuery = "select id,nombre,descripcion from archivos_consulta_trabajo_so where id_consulta='"+session.getAttribute("serial_consulta")+"' "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
