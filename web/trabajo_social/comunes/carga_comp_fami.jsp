<%-- 
    Document   : carga_comp_fami
    Created on : 30/10/2013, 12:41:54 PM
    Author     : Emmanuel
--%>
...
<%@page import="pac.conexion" %>
  ...
  <%
                            ...
                            if(busca.compareTo("true")==0){
                                        ...
                                        try {
                                             ...
                                             for(int i=0;i<Integer.parseInt(""+msg.size());i++){   ///ago un ciclo para todad las restricciones
                                                ...
                                                if(campo.compareTo("d3")==0){campo="o.descripcion";}
                                                if(campo.compareTo("d2")==0){campo="e.descripcion";}
                                                else if(campo.compareTo("d1")==0){campo="p.descripcion";}
                         ...
                         //  System.out.println(where);
                            ...
                            total = conexiondb.countRec("id_comp_fami", "comp_fami c,escolaridad_trab_soci e,ocupacion_trabajo_soci o,parentesco_trab_soci p where c.ocupacion=o.idocupacion_trabajo_soci and c.parentesco=p.idparentesco and c.escolaridad=e.idescolaridad_trab_soci and id_cons_trab_soci='"+session.getAttribute("serial_consulta")+"' "+where+"");
                            ...
                            strQuery = "select id_comp_fami,nombre_apellidos,p.descripcion as d1,edad,e.descripcion as d2,o.descripcion as d3,observaciones from comp_fami c,escolaridad_trab_soci e,ocupacion_trabajo_soci o,parentesco_trab_soci p where c.ocupacion=o.idocupacion_trabajo_soci and c.parentesco=p.idparentesco and c.escolaridad=e.idescolaridad_trab_soci and id_cons_trab_soci='"+session.getAttribute("serial_consulta")+"' "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
    //   System.out.println(strQuery);    
                           ...
                           // total = conexiondb.countRec("id_comp_fami", "comp_fami c,escolaridad_trab_soci e,ocupacion_trabajo_soci o,parentesco_trab_soci p where c.ocupacion=o.idocupacion_trabajo_soci and c.parentesco=p.idparentesco and c.escolaridad=e.idescolaridad_trab_soci and id_cons_trab_soci='"+session.getAttribute("serial_consulta")+"' "+where+"");
                            ...
                            while(rs.next()){
                                ...
                                json = json + "\n{";
                                json = json + "\"id\":\""+rs.getInt("id_comp_fami") +"\",";
                                json = json + "\"cell\":["+rs.getInt("id_comp_fami") +"";
                                json = json + ",\""+rs.getString("nombre_apellidos")+"\""; 
                                json = json + ",\""+rs.getString("d1")+"\"";  
                                json = json + ",\""+rs.getString("edad")+"\"";  
                                json = json + ",\""+rs.getString("d2")+"\"";  
                                json = json + ",\""+rs.getString("d3")+"\"";  
                                json = json + ",\""+rs.getString("observaciones")+"\"]";
                                json = json + "}";
