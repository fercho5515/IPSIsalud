       ...
       <% request.setCharacterEncoding("UTF-8");
        ...
        try {           Calendar cal1 = Calendar.getInstance();
			...
			out.println("<center> <br><h2>Copia realizada con éxito<h2> </center><br> ");
                   ...
                   out.print("<center> <a href='../respaldos/copias_r/copiaDB_"+fecha+".zip' >descargar</a></center> "); 
              //   out.print(" <embed src='/home/servidor/Documentos/copiasBD/copiaDB_"+fecha+".zip' width='100%' height='100%' style='min-height:750px'></embed> ");
                   //    
               } catch (Exception e) {
			e.printStackTrace();
		}
