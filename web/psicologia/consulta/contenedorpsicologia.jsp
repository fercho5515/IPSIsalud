...
/////////////////////////////
 ...
 $(function() {
  ...
  function guarda_consulta_psico(){  
      ...
      var descue=document.getElementById("desusupadienfer").value;//Descripción del usuario ante el padecimiento de la enfermedad
      var histf=document.getElementById("historia_familiar").value;//Historia Personal y Familiar
      var aspsicoe=document.getElementById("aspectos_psico_enf").value;//Aspectos Psicológicos de la enfermedad
      var porte_actidud=document.getElementById("porte_actidud").value;//Porte y actitud:
      var conciencia=document.getElementById("conciencia").value;//Consciencia:
      var humor_afectividad=document.getElementById("humor_afectividad").value;//Humor y afectividad:
      var caracteristicas_lenguaje=document.getElementById("caracteristicas_lenguaje").value;//Características del lenguaje:
      var senso_percepcion=document.getElementById("senso_percepcion").value;//Senso - percepción:
      var pensamiento=document.getElementById("pensamiento").value;//Pensamiento:
      var alteracion_ritmos=document.getElementById("alteracion_ritmos").value;//Alteración de ritmos Vitales (Sueño, sexualidad, conducta alimentaria):
      var juicio=document.getElementById("juicio").value;//Juicio:
      var memoria=document.getElementById("memoria").value;//Memoria:
      var atencion=document.getElementById("atencion").value;//Pensamiento:
      var psicomotricidad=document.getElementById("psicomotricidad").value;//Psicomotricidad
      var pro=document.getElementById("pronostico").value;
      var pos=document.getElementById("postulacion_trat").value; //Plan de manejo:
      
      var observacionesc=document.getElementById("observacionesc").value; //Observaciones:
      /*
      ...
      var exa=document.getElementById("examen_mental").value; */
          ...
          descue=descue.replace("'","");
          histf=histf.replace("'","");
          aspsicoe=aspsicoe.replace("'","");
          porte_actidud=porte_actidud.replace("'","");
          conciencia=conciencia.replace("'","");
          humor_afectividad=humor_afectividad.replace("'","");
          caracteristicas_lenguaje=caracteristicas_lenguaje.replace("'","");
          senso_percepcion=senso_percepcion.replace("'","");
          pensamiento=pensamiento.replace("'","");
          alteracion_ritmos=alteracion_ritmos.replace("'","");
          juicio=juicio.replace("'","");
          memoria=memoria.replace("'","");
          atencion=atencion.replace("'","");
          psicomotricidad=psicomotricidad.replace("'","");
          observacionesc=observacionesc.replace("'","");
      ...
      if( descue == null || descue.length == 0 || /^\s+$/.test(descue) ) {
                                                      alert('Descripción del usuario ante el padecimiento de la enfermedad es obligatorio');
                                                      return false;  
                                                                      } 
      if( histf == null || histf.length == 0 || /^\s+$/.test(histf) ) {
                                                      alert('Historia Personal y Familiar es obligatorio');
                                                      return false;  
                                                                      } 
      if( aspsicoe == null || aspsicoe.length == 0 || /^\s+$/.test(aspsicoe) ) {
                                                      alert('Aspectos Psicológicos de la enfermedad es obligatorio');
                                                      return false;  
                                                                      } 
      if( porte_actidud == null || porte_actidud.length == 0 || /^\s+$/.test(porte_actidud) ) {
                                                      alert('Porte y actitud:');
                                                      return false;  
                                                                      } 
      if( conciencia == null || conciencia.length == 0 || /^\s+$/.test(conciencia) ) {
                                                      alert('Consciencia es obligatorio');
                                                      return false;  
                                                                      } 
      if( humor_afectividad == null || humor_afectividad.length == 0 || /^\s+$/.test(humor_afectividad) ) {
                                                      alert('Humor y afectividad es obligatorio');
                                                      return false;  
                                                                      } 
      if( caracteristicas_lenguaje == null || caracteristicas_lenguaje.length == 0 || /^\s+$/.test(caracteristicas_lenguaje) ) {
                                                      alert('Características del lenguaje es obligatorio');
                                                      return false;  
                                                                      } 
      if( senso_percepcion == null || senso_percepcion.length == 0 || /^\s+$/.test(senso_percepcion) ) {
                                                      alert('Senso - percepción es obligatorio');
                                                      return false;  
                                                                      } 
      if( pensamiento == null || pensamiento.length == 0 || /^\s+$/.test(pensamiento) ) {
                                                      alert('Pensamiento es obligatorio');
                                                      return false;  
                                                                      } 
      if( alteracion_ritmos == null || alteracion_ritmos.length == 0 || /^\s+$/.test(alteracion_ritmos) ) {
                                                      alert('Alteración de ritmos Vitales (Sueño, sexualidad, conducta alimentaria) es obligatorio');
                                                      return false;  
                                                                      } 
      if( juicio == null || juicio.length == 0 || /^\s+$/.test(juicio) ) {
                                                      alert('Juicio es obligatorio');
                                                      return false;  
                                                                      } 
      if( memoria == null || memoria.length == 0 || /^\s+$/.test(memoria) ) {
                                                      alert('Memoria es obligatorio');
                                                      return false;  
                                                                      } 
      if( atencion == null || atencion.length == 0 || /^\s+$/.test(atencion) ) {
                                                      alert('Atención es obligatorio');
                                                      return false;  
                                                                      } 
      if( psicomotricidad == null || psicomotricidad.length == 0 || /^\s+$/.test(psicomotricidad) ) {
                                                      alert('Psicomotricidad es obligatorio');
                                                      return false;  
                                                                      } /*
      ...
      if( pos == null || pos.length == 0 || /^\s+$/.test(pos) ) {
                                                      alert('Plan de manejo es obligatoria');
                                                      return false;  
                                                                      } 
      if( observacionesc == null || observacionesc.length == 0 || /^\s+$/.test(observacionesc) ) {
                                                      alert('Observaciones son obligatorias');
                                                      return false;  
                                                                      } 
         ...
         document.getElementById("pronostico_r").value  =$("#pronostico").val();
         document.getElementById("postulacion_trat_r").value  =$("#postulacion_trat").val();
         document.getElementById("observacionesc_r").value  =$("#observacionesc").val();
...
$('#nuevo_diag_psico').submit(function() {
                      ...
                      /*     if( nom2 == null || nom2.length == 0 || /^\s+$/.test(nom2) ) {
                          ...
                          if(ids.length==4){alert('Solo se permite un diagnostico principal y tres relacionados');
                           ...
                           document.getElementById("observaciones").value=nom2.replace("\"", "'").replace(/\r\n|\n|\r/g, " ");                         
                    // Enviamos el formulario usando AJAX
...
<body >
    ...
    <br><center><a href="../index.jsp">volver</a></center>
          ...
          //  System.out.println("INSERT INTO `ips_isalud`.`histo_psicologica` (`serial`, `fecha_apertura`) VALUES ('"+ced_pacinet+"',now());"); 
            ...
            if(id_consulta == -1 ){
            String cons_a="select max(id_consulta) from consulta_psico where id_tipo='2' and guardado='0' and id_historia='"+ced_pacinet+"' and id_consulta not in (select id_consulta from agenda where (id_permiso='5' or id_permiso='14' ) and id_agenda != '"+cod_agenda+"' and id_consulta != 'null' )";
...
<form id="consu_psico_1" name="consu_psico_1" method="post" target="el-iframe1" accept-charset="UTF-8" action="guarda_consu_psico_1.jsp">
     ...
     <input type="hidden" id="pronostico_r" name="pronostico">
     <input type="hidden" id="postulacion_trat_r" name="postulacion_trat">
     <input type="hidden" id="observacionesc_r" name="observacionesc">
...
<fieldset>
<legend>Actitud ante el encuentro inicial:</legend>
    <select id="actitud_psicologia" name="actitud_psicologia">
        <%
        
              
         String sqlcon="SELECT id,descripcion FROM actitud_psicologia";
       
         ResultSet resu=null;
          try{  
              
           resu=ba.consultas(sqlcon);
    ...
    <br><br>
    <textarea name="actitudtext" id="actitudtext" style="width:100%;"></textarea>
    
</fieldset>   
     
 
<fieldset>
    <legend>Descripción del usuario ante el padecimiento de la enfermedad:</legend>
    <textarea name="desusupadienfer" id="desusupadienfer" style="width:100%;"></textarea>
</fieldset>       

<fieldset>
<legend>Historia Personal y Familiar:</legend>
<textarea id="historia_familiar" name="historia_familiar" rows="3" style="width:100%"></textarea>
</fieldset>        
  
<fieldset>
<legend>Aspectos Psicológicos de la enfermedad:</legend>
<textarea id="aspectos_psico_enf" name="aspectos_psico_enf" rows="3" style="width:100%"></textarea>
</fieldset>         
...
<table style="width:100%">
    <tr>
        <td>
           <label> Porte y actitud: </label>
        </td>
    </tr>
    <tr>
        <td>
            <textarea id="porte_actidud" name="porte_actidud" rows="3" style="width:100%"></textarea>
        </td>
    </tr>
    <tr>
        <td>
            <label> Consciencia: </label>
        </td>        
    </tr>
    <tr>
        <td>
            <textarea id="conciencia" name="conciencia" rows="3" style="width:100%"></textarea>
        </td>
    </tr>
    <tr>
        <td>
            <label> Humor y afectividad: </label>
        </td>
    </tr>
    <tr>
        <td>
            <textarea id="humor_afectividad" name="humor_afectividad" rows="3" style="width:100%"></textarea>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            <textarea id="caracteristicas_lenguaje" name="caracteristicas_lenguaje" rows="3" style="width:100%"></textarea>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            <textarea id="senso_percepcion" name="senso_percepcion" rows="3" style="width:100%"></textarea>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            <textarea id="pensamiento" name="pensamiento" rows="3" style="width:100%"></textarea>
        </td>
    </tr>
    <tr>
        <td>
            <label> Alteración de ritmos Vitales (Sueño, sexualidad, conducta alimentaria):</label>
        </td>
    </tr>
    <tr>
        <td>
            <textarea id="alteracion_ritmos" name="alteracion_ritmos" rows="3" style="width:100%"></textarea>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            <textarea id="juicio" name="juicio" rows="3" style="width:100%"></textarea>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
         <td>
            <textarea id="memoria" name="memoria" rows="3" style="width:100%"></textarea>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            <textarea id="atencion" name="atencion" rows="3" style="width:100%"></textarea>
        </td>
    </tr>
    <tr>
        <td>
            <label>Psicomotricidad:</label>
        </td>
    </tr>
    <tr>
        <td>
            <textarea id="psicomotricidad" name="psicomotricidad" rows="3" style="width:100%"></textarea>
        </td>
    </tr>
...
<fieldset>
<legend>Actitud del paciente en la consulta:</legend>
...
<fieldset>
<legend>Plan de manejo:</legend>
<textarea id="postulacion_trat" name="postulacion_trat" rows="3" style="width:100%"></textarea>
</fieldset>
 
<fieldset>
<legend>Observaciones:</legend>
<textarea id="observacionesc" name="observacionesc" rows="3" style="width:100%"></textarea>
</fieldset>
