...
/////////////////////////////
 ...
 $(function() {
  ...
  function guarda_consulta_psico(){  
      ...
      var ana=document.getElementById("analisis_descri").value;        
          ana=ana.replace("'","");
          document.getElementById("analisis_descri").value=ana;    
      if( ana == null || ana.length == 0 || /^\s+$/.test(ana) ) {
                                                      alert('Agregue el Análisis descriptivo del paciente ante el padecimiento de la enfermedad');
                                                      return false;  
                                                                      } 
...
<body >
    ...
    <br><center><a href="/ISALUD/index.jsp">volver</a></center>
          ...
          //  System.out.println("INSERT INTO `ips_isalud`.`histo_psicologica` (`serial`, `fecha_apertura`) VALUES ('"+ced_pacinet+"',now());"); 
            ...
            if(id_consulta == -1 ){
            String cons_a="select max(id_consulta) from consulta_psico where id_tipo='3' and guardado='0' and id_historia='"+ced_pacinet+"' and id_consulta not in (select id_consulta from agenda where (id_permiso='5' or id_permiso='14' ) and id_agenda != '"+cod_agenda+"' and id_consulta != 'null' )";
            ...
            ResultSet resu2a=ba.consultas(cons_a);
             ...
             if(id_consulta==-1){
                if(ba.transaccion("INSERT INTO `ips_isalud`.`consulta_psico` (`id_historia`, `id_tipo`, `guardado`) VALUES ('"+ced_pacinet+"', 3, 0);")){
...
<fieldset>
<legend>Análisis descriptivo del paciente ante el padecimiento de la enfermedad:</legend>
<textarea id="analisis_descri" name="analisis_descri" rows="3" style="width:100%"></textarea>
</fieldset>   
</form>  
