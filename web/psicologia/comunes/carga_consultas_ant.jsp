<%-- 
    Document   : carga_consultas_ant.jsp
    Created on : 10/08/2013, 06:20:11 PM
    Author     : Emmanuel
--%>
...
<%@page import="pac.conexion" %>
  ...
  <%
                         ...
                         //  System.out.println(where);
                           ...
                           // String dd="1";
                            String dd="3"; 
                             total = conexiondb.countRec("co.id_consulta ", " agenda a,procedimientos_tari p,cups c,consulta_psico co  where a.id_procedimiento=p.idprocedimientos_tari  and p.cod_cups=c.id_cups  and co.id_consulta=a.id_consulta and a.id_paciente='"+session.getAttribute("serial_pacinete")+"' and co.guardado='"+dd+"' "+where+"");
                            ...
                            strQuery = "select co.id_consulta,date(co.fecha) as fecha,c.descripcion as descripcion from agenda a,procedimientos_tari p,cups c,consulta_psico co  where a.id_procedimiento=p.idprocedimientos_tari  and p.cod_cups=c.id_cups  and co.id_consulta=a.id_consulta and a.id_paciente='"+session.getAttribute("serial_pacinete")+"' and co.guardado='"+dd+"' "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
    //  System.out.println("carga consulta ant psico ==>"+strQuery);
                            ...
                            while(rs.next()){
                                ...
                                json = json + "\n{";
                                json = json + "\"id\":\""+rs.getInt("id_consulta")+"\",";
                                json = json + "\"cell\":["+rs.getInt("id_consulta")+"";
