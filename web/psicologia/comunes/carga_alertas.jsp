...
<%@page import="pac.conexion" %>
  ...
  <%
                          ...
                          // System.out.println(where);
                            ...
                            total = conexiondb.countRec("id_alertas", " alertas a,personas p1 where a.id_empleado_crea=p1.serial and (a.id_permiso='5' or a.id_permiso='14') and a.leido='0' and id_paciente='"+session.getAttribute("serial_pacinete")+"'  "+where+"");
                        //      System.out.print("aa");
                            if( total>0 ) {
                            ...
                            strQuery = "select id_alertas,alerta,p1.p_nom,p1.s_nom,p1.p_ape,p1.s_ape,fecha_crea from alertas a,personas p1 where a.id_empleado_crea=p1.serial and (a.id_permiso='5' or a.id_permiso='14') and a.leido='0' and id_paciente='"+session.getAttribute("serial_pacinete")+"' "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
