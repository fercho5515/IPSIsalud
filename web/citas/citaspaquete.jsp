...
//        anchoPantalla=document.body.offsetWidth -((document.body.offsetWidth*24)/100);
        ...
        jQuery("#listcitaspaciente").jqGrid({
            ...
            datatype: "json",
            colNames:['ID','','Especialidad','Hora','Fecha','Serial'],
            colModel:[
                {name:'ida',index:'ida', width:(anchoPantalla*0.30*0.1),hidden:false,search:true,editable: true,editrules: { required: true },searchoptions:{sopt:['cn','eq']}},
                {name:'proc',index:'proc',width:180,hidden:true,editable: false,required : true,editoptions:{maxlength: 63}},
                {name:'descr',index:'descr',width:(anchoPantalla*0.30*0.55),editable: false,required : true,editoptions:{maxlength: 63}},
                {name:'hora',index:'hora', width:(anchoPantalla*0.30*0.1),search:true, editable: true,required : true,editoptions: {maxlength: 43},editrules: { required: true },searchoptions:{sopt:['cn','eq']}},
...
//            autowidth: true,
            ...
            caption: "Citas del Paciente Paquete",
...
//        {width:400} //para el view
        ...
        /**--------------------------------*/
        /*-------------------------------*/
        jQuery("#listseviciospaquete22").jqGrid({
            url:'cargar_serviciospaquete.jsp',
            datatype: "json",
            colNames:['ID','Especialidad','Proce','Tari','Cont','Paq','Cup','Bandera'],
            colModel:[
                {name:'conta',index:'conta', width:(anchoPantalla*0.30*0.1),hidden:false,search:true,editable: true,editrules: { required: true },searchoptions:{sopt:['cn','eq']}},
                {name:'descr',index:'descr',width:(anchoPantalla*0.30*0.5),editable: false,required : true,editoptions:{maxlength: 63}},
                ...
                {name:'cont',index:'cont', width:(anchoPantalla*0.30*0.1),search:true, editable: true,required : true,editoptions: {maxlength: 43},editrules: { required: true },searchoptions:{sopt:['cn','eq']}},
                {name:'paq',index:'paq', width:(anchoPantalla*0.30*0.1),search:true, editable: true,required : true,editoptions: {maxlength: 43},editrules: { required: true },searchoptions:{sopt:['cn','eq']}},
...
//            autowidth:true,
            ...
            onSelectRow: function (conta){  
                ...
                var lineap=jQuery("#listseviciospaquete22").jqGrid('getRowData',conta);
...
//            $("#cambia_dia").load("cambia_dia.jsp?dato="+vcontra+"")
            ...
            var contra = jQuery("#paquete").val();
            jQuery("#listseviciospaquete22").jqGrid('setGridParam',{url:"cargar_serviciospaquete.jsp?contra="+contra+"&ide="+ide}).trigger("reloadGrid");
       }
                    ...
                    <fieldset style="width: 95%">
                        ...
                        <table border="0" >
                            <tr>
                                ...
                                <td colspan="2"><input type="text" name="id_citas" id="id_citas" onchange="cambia_paquetes();"></td>
                                <td>
                                ...
                                <td colspan="2">
                                    <div id="div_contra" name="div_contra">
                                        <select name="contra" id="contra"> 
                                            ...
                                            <option value="escoger">--Escoja un Paquete--</option>
                                        </select>
                                    </div></td>
                                <td> </td>
                            </tr>
...
<!--        <div style="margin-top:2%;display: inline-flex; margin-left: 1%">-->
        <div style="margin-top:2%;margin-left: 1%">
            ...
            <table id="listseviciospaquete22" ></table>
            <div id="pagerseviciospaquete22"></div>
        </div>
        <div style="margin-top:2%; margin-left: 1%">    
