  ...
  <%
                         ...
                         //  System.out.println(where);
                          ...
                          //  strQuery = "SELECT serial_paciente as serialp,procedimientos_tari.descripcion as descr,procedimientos_cont.cod_activ as proce,procedimientos_cont.cod_tarifario as tari,procedimientos_cont.id_contrato as cont FROM afiliados_cont,contratacion,procedimientos_cont,tari_proced,procedimientos_tari,pacientes,personas where afiliados_cont.id_cont=contratacion.id_contratacion and procedimientos_cont.id_contrato=contratacion.id_contratacion and procedimientos_cont.cod_activ=tari_proced.id_proced and procedimientos_cont.cod_tarifario=id_tarifario and procedimientos_tari.idprocedimientos_tari=tari_proced.id_proced and pacientes.serial_persona=afiliados_cont.serial_paciente and personas.serial=pacientes.serial_persona and personas.id_person="+ide+" and afiliados_cont.id_cont="+contra+" and afiliados_cont.activo=1"+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
                            strQuery = "SELECT serial_paciente as serialp,procedimientos_tari.descripcion as descr,procedimientos_cont.cod_activ as proce,procedimientos_cont.cod_tarifario as tari,procedimientos_cont.id_contrato as cont, 0 as paq,'Contrato' as bande,cups.cup_verdadero as cup FROM afiliados_cont,contratacion,procedimientos_cont,tari_proced,procedimientos_tari,pacientes,personas,cups where afiliados_cont.id_cont=contratacion.id_contratacion and procedimientos_cont.id_contrato=contratacion.id_contratacion and procedimientos_cont.cod_activ=tari_proced.id_proced and procedimientos_cont.cod_tarifario=id_tarifario and procedimientos_tari.idprocedimientos_tari=tari_proced.id_proced and pacientes.serial_persona=afiliados_cont.serial_paciente and personas.serial=pacientes.serial_persona and personas.id_person="+ide+" and afiliados_cont.id_cont="+contra+" and afiliados_cont.activo=1 and cups.id_cups=procedimientos_tari.cod_cups "+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
