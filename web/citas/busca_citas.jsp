...
<%@page import="pac.conexion" %>
  <%
                            ...
                            int prof = new Integer(request.getParameter("prof"));
                         ...
                         //  System.out.println(where);
                            ...
                            conexiondb.Conectar();
                            /*-----------------------------------------------------------------------------------------------------------*/
                            total = conexiondb.countRec("pe.id_person", "personas pe,pacientes pa, agenda ag  where pe.serial=pa.serial_persona and pa.serial_persona=ag.id_paciente and ag.fecha='"+dia+"'and ag.id_medico='"+prof+"'"+where+"");
                            if( total>0 ) {
                            ...
                            strQuery = "select pe.id_person as iden,concat(pe.p_nom,' ',pe.p_ape) as nombre,ag.hora,ag.min,ag.am_pm from personas pe,pacientes pa, agenda ag  where pe.serial=pa.serial_persona and pa.serial_persona=ag.id_paciente and ag.fecha='"+dia+"'and ag.id_medico='"+prof+"'"+where+" ORDER BY "+sidx + " " +sord +" LIMIT "+start+" , "+limit;
                           ...
                           // total = conexiondb.countRec("pe.id_person", "personas pe,pacientes pa, agenda ag  where pe.serial=pa.serial_persona and pa.serial_persona=ag.id_paciente and ag.fecha='"+dia+"'and ag.id_medico='"+prof+"'"+where+"");
                            ...
                            while(rs.next()){
                                ...
                                json = json + "\n{";
                                json = json + "\"id\":\""+rs.getInt("iden")+"\",";
                                json = json + "\"cell\":["+rs.getInt("iden")+"";
                                json = json + ",\""+rs.getString("nombre")+"\"";                                
                                json = json + ",\""+rs.getString("hora")+"\"";
                                json = json + ",\""+rs.getString("min")+"\"";
